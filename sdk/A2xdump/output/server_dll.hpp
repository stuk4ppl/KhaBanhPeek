...
namespace cs2_dumper {
    namespace schemas {
        ...
        namespace server_dll {
            ...
            namespace CFists {
                constexpr std::ptrdiff_t m_bPlayingUninterruptableAct = 0xF58; // 
                constexpr std::ptrdiff_t m_nUninterruptableActivity = 0xF5C; // 
                constexpr std::ptrdiff_t m_bRestorePrevWep = 0xF60; // 
                constexpr std::ptrdiff_t m_hWeaponBeforePrevious = 0xF64; // 
                constexpr std::ptrdiff_t m_hWeaponPrevious = 0xF68; // 
                constexpr std::ptrdiff_t m_bDelayedHardPunchIncoming = 0xF6C; // 
                constexpr std::ptrdiff_t m_bDestroyAfterTaunt = 0xF6D; // 
            }
            // Parent: CBaseTrigger
            // Field count: 1
            ...
            namespace CBaseCSGrenade {
                constexpr std::ptrdiff_t m_bRedraw = 0xF58; // 
                constexpr std::ptrdiff_t m_bIsHeldByPlayer = 0xF59; // 
                constexpr std::ptrdiff_t m_bPinPulled = 0xF5A; // 
                constexpr std::ptrdiff_t m_bJumpThrow = 0xF5B; // 
                constexpr std::ptrdiff_t m_bThrowAnimating = 0xF5C; // 
                constexpr std::ptrdiff_t m_fThrowTime = 0xF60; // 
                constexpr std::ptrdiff_t m_flThrowStrength = 0xF64; // 
                constexpr std::ptrdiff_t m_flThrowStrengthApproach = 0xF68; // 
                constexpr std::ptrdiff_t m_fDropTime = 0xF6C; // 
                constexpr std::ptrdiff_t m_fPinPullTime = 0xF70; // 
                constexpr std::ptrdiff_t m_bJustPulledPin = 0xF74; // 
                constexpr std::ptrdiff_t m_nNextHoldTick = 0xF78; // 
                constexpr std::ptrdiff_t m_flNextHoldFrac = 0xF7C; // 
                constexpr std::ptrdiff_t m_hSwitchToWeaponAfterThrow = 0xF80; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 1
            ...
            namespace CWeaponBaseItem {
                constexpr std::ptrdiff_t m_SequenceCompleteTimer = 0xF58; // 
            ...
            // Field count: 1
            namespace CKnife {
                constexpr std::ptrdiff_t m_bFirstAttack = 0xF58; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 37
            ...
            namespace CSmokeGrenadeProjectile {
                ...
                constexpr std::ptrdiff_t m_flLastBounce = 0xBA8; // 
                constexpr std::ptrdiff_t m_fllastSimulationTime = 0xBAC; // 
                constexpr std::ptrdiff_t m_bExplodeFromInferno = 0x2E30; // 
            }
            ...
            namespace CBaseCSGrenadeProjectile {
                ...
                constexpr std::ptrdiff_t m_bHasEverHitPlayer = 0xB4C; // 
                constexpr std::ptrdiff_t m_bClearFromPlayers = 0xB4D; // 
            }
            // Parent: CServerOnlyModelEntity
            // Field count: 1
            namespace CCSPlace {
            ...
            namespace CCSWeaponBase {
                ...
                constexpr std::ptrdiff_t m_hPrevOwner = 0xEF8; // 
                constexpr std::ptrdiff_t m_nDropTick = 0xEFC; // 
            ...
            namespace CWeaponShield {
                constexpr std::ptrdiff_t m_flBulletDamageAbsorbed = 0xF78; // 
                constexpr std::ptrdiff_t m_flLastBulletHitSoundTime = 0xF7C; // 
                constexpr std::ptrdiff_t m_flDisplayHealth = 0xF80; // 
            }
            // Parent: CPointEntity
            // Field count: 4
            namespace CBlood {
            ...
            namespace CPointWorldText {
                ...
                constexpr std::ptrdiff_t m_bEnabled = 0x9D0; // 
                constexpr std::ptrdiff_t m_bFullbright = 0x9D1; // 
                constexpr std::ptrdiff_t m_flWorldUnitsPerPx = 0x9D4; // 
                constexpr std::ptrdiff_t m_flFontSize = 0x9D8; // 
                constexpr std::ptrdiff_t m_flDepthOffset = 0x9DC; // 
                constexpr std::ptrdiff_t m_Color = 0x9E0; // 
                constexpr std::ptrdiff_t m_nJustifyHorizontal = 0x9E4; // 
                constexpr std::ptrdiff_t m_nJustifyVertical = 0x9E8; // 
                constexpr std::ptrdiff_t m_nReorientMode = 0x9EC; // 
            }
            // Parent: CSoundAreaEntityBase
            // Field count: 2
            //
            ...
            namespace CWeaponTaser {
                constexpr std::ptrdiff_t m_fFireTime = 0xF78; // 
                constexpr std::ptrdiff_t m_nLastAttackTick = 0xF7C; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 0
            ...
            namespace CCSWeaponBaseGun {
                constexpr std::ptrdiff_t m_zoomLevel = 0xF58; // 
                constexpr std::ptrdiff_t m_iBurstShotsRemaining = 0xF5C; // 
                constexpr std::ptrdiff_t m_silencedModelIndex = 0xF68; // 
                constexpr std::ptrdiff_t m_inPrecache = 0xF6C; // 
                constexpr std::ptrdiff_t m_bNeedsBoltAction = 0xF6D; // 
                constexpr std::ptrdiff_t m_bSkillReloadAvailable = 0xF6E; // 
                constexpr std::ptrdiff_t m_bSkillReloadLiftedReloadKey = 0xF6F; // 
                constexpr std::ptrdiff_t m_bSkillBoltInterruptAvailable = 0xF70; // 
                constexpr std::ptrdiff_t m_bSkillBoltLiftedFireKey = 0xF71; // 
            }
            // Parent: None
            // Field count: 13
            namespace CBot {
            ...
            namespace CCSPlayerPawn {
                ...
                constexpr std::ptrdiff_t m_xLastHeadBoneTransform = 0x1600; // 
                constexpr std::ptrdiff_t m_bLastHeadBoneTransformIsValid = 0x1620; // 
                constexpr std::ptrdiff_t m_lastLandTime = 0x1624; // 
                constexpr std::ptrdiff_t m_bOnGroundLastTick = 0x1628; // 
                constexpr std::ptrdiff_t m_iPlayerLocked = 0x162C; // 
                constexpr std::ptrdiff_t m_flTimeOfLastInjury = 0x1634; // 
                constexpr std::ptrdiff_t m_flNextSprayDecalTime = 0x1638; // 
                constexpr std::ptrdiff_t m_bNextSprayDecalTimeExpedited = 0x163C; // 
                constexpr std::ptrdiff_t m_nRagdollDamageBone = 0x1640; // 
                constexpr std::ptrdiff_t m_vRagdollDamageForce = 0x1644; // 
                constexpr std::ptrdiff_t m_vRagdollDamagePosition = 0x1650; // 
                constexpr std::ptrdiff_t m_szRagdollDamageWeaponName = 0x165C; // 
                constexpr std::ptrdiff_t m_bRagdollDamageHeadshot = 0x169C; // 
                constexpr std::ptrdiff_t m_vRagdollServerOrigin = 0x16A0; // 
                constexpr std::ptrdiff_t m_EconGloves = 0x16B0; // 
                constexpr std::ptrdiff_t m_nEconGlovesChanged = 0x1928; // 
                constexpr std::ptrdiff_t m_qDeathEyeAngles = 0x192C; // 
                constexpr std::ptrdiff_t m_bSkipOneHeadConstraintUpdate = 0x1938; // 
                constexpr std::ptrdiff_t m_bLeftHanded = 0x1939; // 
                constexpr std::ptrdiff_t m_fSwitchedHandednessTime = 0x193C; // 
                constexpr std::ptrdiff_t m_flViewmodelOffsetX = 0x1940; // 
                constexpr std::ptrdiff_t m_flViewmodelOffsetY = 0x1944; // 
                constexpr std::ptrdiff_t m_flViewmodelOffsetZ = 0x1948; // 
                constexpr std::ptrdiff_t m_flViewmodelFOV = 0x194C; // 
                constexpr std::ptrdiff_t m_bIsWalking = 0x1950; // 
                constexpr std::ptrdiff_t m_fLastGivenDefuserTime = 0x1954; // 
                constexpr std::ptrdiff_t m_fLastGivenBombTime = 0x1958; // 
                constexpr std::ptrdiff_t m_flDealtDamageToEnemyMostRecentTimestamp = 0x195C; // 
                constexpr std::ptrdiff_t m_iDisplayHistoryBits = 0x1960; // 
                constexpr std::ptrdiff_t m_flLastAttackedTeammate = 0x1964; // 
                constexpr std::ptrdiff_t m_allowAutoFollowTime = 0x1968; // 
                constexpr std::ptrdiff_t m_bResetArmorNextSpawn = 0x196C; // 
                constexpr std::ptrdiff_t m_nLastKillerIndex = 0x1970; // 
                constexpr std::ptrdiff_t m_entitySpottedState = 0x1978; // 
                constexpr std::ptrdiff_t m_nSpotRules = 0x1990; // 
                constexpr std::ptrdiff_t m_bIsScoped = 0x1994; // 
                constexpr std::ptrdiff_t m_bResumeZoom = 0x1995; // 
                constexpr std::ptrdiff_t m_bIsDefusing = 0x1996; // 
                constexpr std::ptrdiff_t m_bIsGrabbingHostage = 0x1997; // 
                constexpr std::ptrdiff_t m_iBlockingUseActionInProgress = 0x1998; // 
                constexpr std::ptrdiff_t m_flEmitSoundTime = 0x199C; // 
                constexpr std::ptrdiff_t m_bInNoDefuseArea = 0x19A0; // 
                constexpr std::ptrdiff_t m_iBombSiteIndex = 0x19A4; // 
                constexpr std::ptrdiff_t m_nWhichBombZone = 0x19A8; // 
                constexpr std::ptrdiff_t m_bInBombZoneTrigger = 0x19AC; // 
                constexpr std::ptrdiff_t m_bWasInBombZoneTrigger = 0x19AD; // 
                constexpr std::ptrdiff_t m_iShotsFired = 0x19B0; // 
                constexpr std::ptrdiff_t m_flFlinchStack = 0x19B4; // 
                constexpr std::ptrdiff_t m_flVelocityModifier = 0x19B8; // 
                constexpr std::ptrdiff_t m_flHitHeading = 0x19BC; // 
                constexpr std::ptrdiff_t m_nHitBodyPart = 0x19C0; // 
                constexpr std::ptrdiff_t m_vecTotalBulletForce = 0x19C4; // 
                constexpr std::ptrdiff_t m_bWaitForNoAttack = 0x19D0; // 
                constexpr std::ptrdiff_t m_ignoreLadderJumpTime = 0x19D4; // 
                constexpr std::ptrdiff_t m_bKilledByHeadshot = 0x19D8; // 
                constexpr std::ptrdiff_t m_LastHitBox = 0x19DC; // 
                constexpr std::ptrdiff_t m_LastHealth = 0x19E0; // 
                constexpr std::ptrdiff_t m_pBot = 0x19E8; // 
                constexpr std::ptrdiff_t m_bBotAllowActive = 0x19F0; // 
                constexpr std::ptrdiff_t m_thirdPersonHeading = 0x19F4; // 
                constexpr std::ptrdiff_t m_flSlopeDropOffset = 0x1A00; // 
                constexpr std::ptrdiff_t m_flSlopeDropHeight = 0x1A04; // 
                constexpr std::ptrdiff_t m_vHeadConstraintOffset = 0x1A08; // 
                constexpr std::ptrdiff_t m_nLastPickupPriority = 0x1A14; // 
                constexpr std::ptrdiff_t m_flLastPickupPriorityTime = 0x1A18; // 
                constexpr std::ptrdiff_t m_ArmorValue = 0x1A1C; // 
                constexpr std::ptrdiff_t m_unCurrentEquipmentValue = 0x1A20; // 
                constexpr std::ptrdiff_t m_unRoundStartEquipmentValue = 0x1A22; // 
                constexpr std::ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x1A24; // 
                constexpr std::ptrdiff_t m_iLastWeaponFireUsercmd = 0x1A28; // 
                constexpr std::ptrdiff_t m_bIsSpawning = 0x1A2C; // 
                constexpr std::ptrdiff_t m_iDeathFlags = 0x1A38; // 
                constexpr std::ptrdiff_t m_bHasDeathInfo = 0x1A3C; // 
                constexpr std::ptrdiff_t m_flDeathInfoTime = 0x1A40; // 
                constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x1A44; // 
                constexpr std::ptrdiff_t m_vecPlayerPatchEconIndices = 0x1A50; // 
                constexpr std::ptrdiff_t m_GunGameImmunityColor = 0x1A64; // 
                constexpr std::ptrdiff_t m_grenadeParameterStashTime = 0x1A68; // 
                constexpr std::ptrdiff_t m_bGrenadeParametersStashed = 0x1A6C; // 
                constexpr std::ptrdiff_t m_angStashedShootAngles = 0x1A70; // 
                constexpr std::ptrdiff_t m_vecStashedGrenadeThrowPosition = 0x1A7C; // 
                constexpr std::ptrdiff_t m_vecStashedVelocity = 0x1A88; // 
                constexpr std::ptrdiff_t m_angShootAngleHistory = 0x1A94; // 
                constexpr std::ptrdiff_t m_vecThrowPositionHistory = 0x1AAC; // 
                constexpr std::ptrdiff_t m_vecVelocityHistory = 0x1AC4; // 
                constexpr std::ptrdiff_t m_PredictedDamageTags = 0x1AE0; // 
                constexpr std::ptrdiff_t m_nHighestAppliedDamageTagTick = 0x1B30; // 
            }
            // Parent: CBaseGrenade
            // Field count: 0
            ...
            // NetworkVarNames: m_entitySpottedState (EntitySpottedState_t)
            namespace CC4 {
                constexpr std::ptrdiff_t m_vecLastValidPlayerHeldPosition = 0xF88; // 
                constexpr std::ptrdiff_t m_vecLastValidDroppedPosition = 0xF94; // 
                constexpr std::ptrdiff_t m_bDoValidDroppedPositionCheck = 0xFA0; // 
                constexpr std::ptrdiff_t m_bStartedArming = 0xFA1; // 
                constexpr std::ptrdiff_t m_fArmedTime = 0xFA4; // 
                constexpr std::ptrdiff_t m_bBombPlacedAnimation = 0xFA8; // 
                constexpr std::ptrdiff_t m_bIsPlantingViaUse = 0xFA9; // 
                constexpr std::ptrdiff_t m_entitySpottedState = 0xFB0; // 
                constexpr std::ptrdiff_t m_nSpotRules = 0xFC8; // 
                constexpr std::ptrdiff_t m_bPlayedArmingBeeps = 0xFCC; // 
                constexpr std::ptrdiff_t m_bBombPlanted = 0xFD3; // 
            }
