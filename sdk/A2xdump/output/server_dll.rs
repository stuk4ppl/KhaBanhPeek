    ...
    pub mod schemas {
        ...
        pub mod server_dll {
            ...
            pub mod CTriggerSoundscape {
                ...
                pub const m_spectators: usize = 0x970; // 
            }
            ...
            pub mod CDynamicProp {
                pub const m_bCreateNavObstacle: usize = 0xB60; // 
                pub const m_bNavObstacleUpdatesOverridden: usize = 0xB61; // 
                pub const m_bUseHitboxesForRenderBox: usize = 0xB62; // 
                pub const m_bUseAnimGraph: usize = 0xB63; // 
                pub const m_pOutputAnimBegun: usize = 0xB68; // 
                pub const m_pOutputAnimOver: usize = 0xB90; // 
                pub const m_pOutputAnimLoopCycleOver: usize = 0xBB8; // 
                pub const m_OnAnimReachedStart: usize = 0xBE0; // 
                pub const m_OnAnimReachedEnd: usize = 0xC08; // 
                pub const m_iszIdleAnim: usize = 0xC30; // 
                pub const m_nIdleAnimLoopMode: usize = 0xC38; // 
                pub const m_bRandomizeCycle: usize = 0xC3C; // 
                pub const m_bStartDisabled: usize = 0xC3D; // 
                pub const m_bFiredStartEndOutput: usize = 0xC3E; // 
                pub const m_bForceNpcExclude: usize = 0xC3F; // 
                pub const m_bCreateNonSolid: usize = 0xC40; // 
                pub const m_bIsOverrideProp: usize = 0xC41; // 
                pub const m_iInitialGlowState: usize = 0xC44; // 
                pub const m_nGlowRange: usize = 0xC48; // 
                pub const m_nGlowRangeMin: usize = 0xC4C; // 
                pub const m_glowColor: usize = 0xC50; // 
                pub const m_nGlowTeam: usize = 0xC54; // 
            }
            ...
            pub mod CFists {
                pub const m_bPlayingUninterruptableAct: usize = 0xF58; // 
                pub const m_nUninterruptableActivity: usize = 0xF5C; // 
                pub const m_bRestorePrevWep: usize = 0xF60; // 
                pub const m_hWeaponBeforePrevious: usize = 0xF64; // 
                pub const m_hWeaponPrevious: usize = 0xF68; // 
                pub const m_bDelayedHardPunchIncoming: usize = 0xF6C; // 
                pub const m_bDestroyAfterTaunt: usize = 0xF6D; // 
            }
            // Parent: CBaseTrigger
            // Field count: 1
            pub mod CTriggerRemove {
                pub const m_OnRemove: usize = 0x960; // 
            }
            // Parent: CBaseFilter
            // Field count: 1
            pub mod CFilterName {
            ...
            pub mod CTriggerMultiple {
                pub const m_OnTrigger: usize = 0x960; // 
            }
            ...
            pub mod CTriggerPush {
                pub const m_angPushEntitySpace: usize = 0x960; // 
                pub const m_vecPushDirEntitySpace: usize = 0x96C; // 
                pub const m_bTriggerOnStartTouch: usize = 0x978; // 
                pub const m_bUsePathSimple: usize = 0x979; // 
                pub const m_iszPathSimpleName: usize = 0x980; // 
                pub const m_PathSimple: usize = 0x988; // 
                pub const m_splinePushType: usize = 0x990; // 
            }
            // Parent: CBaseFilter
            // Field count: 3
            ...
            pub mod CTriggerProximity {
                ...
                pub const m_fRadius: usize = 0x970; // 
                pub const m_nTouchers: usize = 0x974; // 
            ...
            pub mod CTriggerBrush {
                pub const m_OnStartTouch: usize = 0x790; // 
                pub const m_OnEndTouch: usize = 0x7B8; // 
                pub const m_OnUse: usize = 0x7E0; // 
                pub const m_iInputFilter: usize = 0x808; // 
                pub const m_iDontMessageParent: usize = 0x80C; // 
            }
            // Parent: CBeam
            // Field count: 19
            pub mod CEnvBeam {
                pub const m_active: usize = 0x830; // 
                pub const m_spriteTexture: usize = 0x838; // 
                pub const m_iszStartEntity: usize = 0x840; // 
                pub const m_iszEndEntity: usize = 0x848; // 
                pub const m_life: usize = 0x850; // 
                pub const m_boltWidth: usize = 0x854; // 
                pub const m_noiseAmplitude: usize = 0x858; // 
                pub const m_speed: usize = 0x85C; // 
                pub const m_restrike: usize = 0x860; // 
                pub const m_iszSpriteName: usize = 0x868; // 
                pub const m_frameStart: usize = 0x870; // 
                pub const m_vEndPointWorld: usize = 0x874; // 
                pub const m_vEndPointRelative: usize = 0x880; // 
                pub const m_radius: usize = 0x88C; // 
                ...
                pub const m_OnTouchedByEntity: usize = 0x8B0; // 
            }
            // Parent: CBaseTrigger
            // Field count: 2
            ...
            pub mod CTriggerBuoyancy {
                pub const m_BuoyancyHelper: usize = 0x960; // 
                pub const m_flFluidDensity: usize = 0x9E0; // 
            }
            // Parent: CPointEntity
            // Field count: 7
            ...
            pub mod CDecoyProjectile {
                pub const m_nDecoyShotTick: usize = 0xB58; // 
                pub const m_shotsRemaining: usize = 0xB5C; // 
                pub const m_fExpireTime: usize = 0xB60; // 
            ...
            pub mod CBaseCSGrenade {
                pub const m_bRedraw: usize = 0xF58; // 
                pub const m_bIsHeldByPlayer: usize = 0xF59; // 
                pub const m_bPinPulled: usize = 0xF5A; // 
                pub const m_bJumpThrow: usize = 0xF5B; // 
                pub const m_bThrowAnimating: usize = 0xF5C; // 
                pub const m_fThrowTime: usize = 0xF60; // 
                pub const m_flThrowStrength: usize = 0xF64; // 
                pub const m_flThrowStrengthApproach: usize = 0xF68; // 
                pub const m_fDropTime: usize = 0xF6C; // 
                pub const m_fPinPullTime: usize = 0xF70; // 
                pub const m_bJustPulledPin: usize = 0xF74; // 
                pub const m_nNextHoldTick: usize = 0xF78; // 
                pub const m_flNextHoldFrac: usize = 0xF7C; // 
                pub const m_hSwitchToWeaponAfterThrow: usize = 0xF80; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 1
            ...
            pub mod CRevertSaved {
                pub const m_loadTime: usize = 0x790; // 
                pub const m_Duration: usize = 0x794; // 
                pub const m_HoldTime: usize = 0x798; // 
            }
            // Parent: CLogicalEntity
            // Field count: 8
            ...
            pub mod CWeaponBaseItem {
                pub const m_SequenceCompleteTimer: usize = 0xF58; // 
                pub const m_bRedraw: usize = 0xF70; // 
            }
            // Parent: CPointEntity
            // Field count: 0
            ...
            pub mod CPhysicsPropRespawnable {
                pub const m_vOriginalSpawnOrigin: usize = 0xD00; // 
                pub const m_vOriginalSpawnAngles: usize = 0xD0C; // 
                pub const m_vOriginalMins: usize = 0xD18; // 
                pub const m_vOriginalMaxs: usize = 0xD24; // 
                pub const m_flRespawnDuration: usize = 0xD30; // 
            }
            ...
            pub mod CRagdollPropAttached {
                pub const m_boneIndexAttached: usize = 0xB48; // 
                pub const m_ragdollAttachedObjectIndex: usize = 0xB4C; // 
                pub const m_attachmentPointBoneSpace: usize = 0xB50; // 
                pub const m_attachmentPointRagdollSpace: usize = 0xB5C; // 
                pub const m_bShouldDetach: usize = 0xB68; // 
                pub const m_bShouldDeleteAttachedActivationRecord: usize = 0xB78; // 
            }
            // Parent: CItem
            // Field count: 2
            //
            ...
            pub mod CItemDogtags {
                pub const m_OwningPlayer: usize = 0xA80; // 
                pub const m_KillingPlayer: usize = 0xA84; // 
            }
            // Parent: CItem
            // Field count: 32
            pub mod CItemGeneric {
                pub const m_bHasTriggerRadius: usize = 0xA88; // 
                pub const m_bHasPickupRadius: usize = 0xA89; // 
                pub const m_flPickupRadiusSqr: usize = 0xA8C; // 
                pub const m_flTriggerRadiusSqr: usize = 0xA90; // 
                pub const m_flLastPickupCheck: usize = 0xA94; // 
                pub const m_bPlayerCounterListenerAdded: usize = 0xA98; // 
                pub const m_bPlayerInTriggerRadius: usize = 0xA99; // 
                pub const m_hSpawnParticleEffect: usize = 0xAA0; // 
                pub const m_pAmbientSoundEffect: usize = 0xAA8; // 
                pub const m_bAutoStartAmbientSound: usize = 0xAB0; // 
                pub const m_pSpawnScriptFunction: usize = 0xAB8; // 
                pub const m_hPickupParticleEffect: usize = 0xAC0; // 
                pub const m_pPickupSoundEffect: usize = 0xAC8; // 
                pub const m_pPickupScriptFunction: usize = 0xAD0; // 
                pub const m_hTimeoutParticleEffect: usize = 0xAD8; // 
                ...
                pub const m_OnPickup: usize = 0xB00; // 
                pub const m_OnTimeout: usize = 0xB28; // 
                pub const m_OnTriggerStartTouch: usize = 0xB50; // 
                pub const m_OnTriggerTouch: usize = 0xB78; // 
                pub const m_OnTriggerEndTouch: usize = 0xBA0; // 
                pub const m_pAllowPickupScriptFunction: usize = 0xBC8; // 
                pub const m_flPickupRadius: usize = 0xBD0; // 
                pub const m_flTriggerRadius: usize = 0xBD4; // 
                pub const m_pTriggerSoundEffect: usize = 0xBD8; // 
                pub const m_bGlowWhenInTrigger: usize = 0xBE0; // 
                pub const m_glowColor: usize = 0xBE1; // 
                pub const m_bUseable: usize = 0xBE5; // 
            ...
            pub mod CPropDoorRotating {
                pub const m_vecAxis: usize = 0xEE8; // 
                pub const m_flDistance: usize = 0xEF4; // 
                ...
                pub const m_flAjarAngle: usize = 0xF04; // 
                pub const m_angRotationAjarDeprecated: usize = 0xF08; // 
                pub const m_angRotationClosed: usize = 0xF14; // 
                pub const m_angRotationOpenForward: usize = 0xF20; // 
                pub const m_angRotationOpenBack: usize = 0xF2C; // 
                pub const m_angGoal: usize = 0xF38; // 
                pub const m_vecForwardBoundsMin: usize = 0xF44; // 
                pub const m_vecForwardBoundsMax: usize = 0xF50; // 
                pub const m_vecBackBoundsMin: usize = 0xF5C; // 
                pub const m_vecBackBoundsMax: usize = 0xF68; // 
                pub const m_bAjarDoorShouldntAlwaysOpen: usize = 0xF74; // 
            ...
            pub mod CRopeKeyframe {
                pub const m_RopeFlags: usize = 0x798; // 
                pub const m_iNextLinkName: usize = 0x7A0; // 
                pub const m_Slack: usize = 0x7A8; // 
                pub const m_Width: usize = 0x7AC; // 
                pub const m_TextureScale: usize = 0x7B0; // 
                pub const m_nSegments: usize = 0x7B4; // 
                pub const m_bConstrainBetweenEndpoints: usize = 0x7B5; // 
                pub const m_strRopeMaterialModel: usize = 0x7B8; // 
                pub const m_iRopeMaterialModelIndex: usize = 0x7C0; // 
                pub const m_Subdiv: usize = 0x7C8; // 
                pub const m_nChangeCount: usize = 0x7C9; // 
                pub const m_RopeLength: usize = 0x7CA; // 
                pub const m_fLockedPoints: usize = 0x7CC; // 
                pub const m_bCreatedFromMapFile: usize = 0x7CD; // 
                pub const m_flScrollSpeed: usize = 0x7D0; // 
                pub const m_bStartPointValid: usize = 0x7D4; // 
                pub const m_bEndPointValid: usize = 0x7D5; // 
                pub const m_hStartPoint: usize = 0x7D8; // 
                pub const m_hEndPoint: usize = 0x7DC; // 
                pub const m_iStartAttachment: usize = 0x7E0; // 
                pub const m_iEndAttachment: usize = 0x7E1; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 73
            //
            ...
            pub mod CBarnLight {
                pub const m_bEnabled: usize = 0x790; // 
                pub const m_nColorMode: usize = 0x794; // 
                pub const m_Color: usize = 0x798; // 
                pub const m_flColorTemperature: usize = 0x79C; // 
                pub const m_flBrightness: usize = 0x7A0; // 
                pub const m_flBrightnessScale: usize = 0x7A4; // 
                pub const m_nDirectLight: usize = 0x7A8; // 
                pub const m_nBakedShadowIndex: usize = 0x7AC; // 
                pub const m_nLuminaireShape: usize = 0x7B0; // 
                pub const m_flLuminaireSize: usize = 0x7B4; // 
                pub const m_flLuminaireAnisotropy: usize = 0x7B8; // 
                pub const m_LightStyleString: usize = 0x7C0; // 
                pub const m_flLightStyleStartTime: usize = 0x7C8; // 
                pub const m_QueuedLightStyleStrings: usize = 0x7D0; // 
                pub const m_LightStyleEvents: usize = 0x7E8; // 
                pub const m_LightStyleTargets: usize = 0x800; // 
                pub const m_StyleEvent: usize = 0x818; // 
                pub const m_hLightCookie: usize = 0x8D8; // 
                pub const m_flShape: usize = 0x8E0; // 
                pub const m_flSoftX: usize = 0x8E4; // 
                pub const m_flSoftY: usize = 0x8E8; // 
                pub const m_flSkirt: usize = 0x8EC; // 
                pub const m_flSkirtNear: usize = 0x8F0; // 
                pub const m_vSizeParams: usize = 0x8F4; // 
                pub const m_flRange: usize = 0x900; // 
                pub const m_vShear: usize = 0x904; // 
                pub const m_nBakeSpecularToCubemaps: usize = 0x910; // 
                pub const m_vBakeSpecularToCubemapsSize: usize = 0x914; // 
                pub const m_nCastShadows: usize = 0x920; // 
                pub const m_nShadowMapSize: usize = 0x924; // 
                pub const m_nShadowPriority: usize = 0x928; // 
                pub const m_bContactShadow: usize = 0x92C; // 
                pub const m_nBounceLight: usize = 0x930; // 
                pub const m_flBounceScale: usize = 0x934; // 
                pub const m_flMinRoughness: usize = 0x938; // 
                pub const m_vAlternateColor: usize = 0x93C; // 
                pub const m_fAlternateColorBrightness: usize = 0x948; // 
                pub const m_nFog: usize = 0x94C; // 
                pub const m_flFogStrength: usize = 0x950; // 
                pub const m_nFogShadows: usize = 0x954; // 
                pub const m_flFogScale: usize = 0x958; // 
                pub const m_bFogMixedShadows: usize = 0x95C; // 
                pub const m_flFadeSizeStart: usize = 0x960; // 
                pub const m_flFadeSizeEnd: usize = 0x964; // 
                pub const m_flShadowFadeSizeStart: usize = 0x968; // 
                pub const m_flShadowFadeSizeEnd: usize = 0x96C; // 
                pub const m_bPrecomputedFieldsValid: usize = 0x970; // 
                pub const m_vPrecomputedBoundsMins: usize = 0x974; // 
                pub const m_vPrecomputedBoundsMaxs: usize = 0x980; // 
                pub const m_vPrecomputedOBBOrigin: usize = 0x98C; // 
                pub const m_vPrecomputedOBBAngles: usize = 0x998; // 
                pub const m_vPrecomputedOBBExtent: usize = 0x9A4; // 
                pub const m_nPrecomputedSubFrusta: usize = 0x9B0; // 
                pub const m_vPrecomputedOBBOrigin0: usize = 0x9B4; // 
                pub const m_vPrecomputedOBBAngles0: usize = 0x9C0; // 
                pub const m_vPrecomputedOBBExtent0: usize = 0x9CC; // 
                pub const m_vPrecomputedOBBOrigin1: usize = 0x9D8; // 
                pub const m_vPrecomputedOBBAngles1: usize = 0x9E4; // 
                pub const m_vPrecomputedOBBExtent1: usize = 0x9F0; // 
                pub const m_vPrecomputedOBBOrigin2: usize = 0x9FC; // 
                pub const m_vPrecomputedOBBAngles2: usize = 0xA08; // 
                pub const m_vPrecomputedOBBExtent2: usize = 0xA14; // 
                pub const m_vPrecomputedOBBOrigin3: usize = 0xA20; // 
                pub const m_vPrecomputedOBBAngles3: usize = 0xA2C; // 
                pub const m_vPrecomputedOBBExtent3: usize = 0xA38; // 
                pub const m_vPrecomputedOBBOrigin4: usize = 0xA44; // 
                pub const m_vPrecomputedOBBAngles4: usize = 0xA50; // 
                pub const m_vPrecomputedOBBExtent4: usize = 0xA5C; // 
                pub const m_vPrecomputedOBBOrigin5: usize = 0xA68; // 
                pub const m_vPrecomputedOBBAngles5: usize = 0xA74; // 
                pub const m_vPrecomputedOBBExtent5: usize = 0xA80; // 
                pub const m_bPvsModifyEntity: usize = 0xA8C; // 
                pub const m_VisClusters: usize = 0xA90; // 
            }
            // Parent: SpawnPoint
            // Field count: 0
            ...
            pub mod CPropDoorRotatingBreakable {
                pub const m_bBreakable: usize = 0xF80; // 
                pub const m_isAbleToCloseAreaPortals: usize = 0xF81; // 
                pub const m_currentDamageState: usize = 0xF84; // 
            ...
            pub mod CLightGlow {
                pub const m_nHorizontalSize: usize = 0x790; // 
                pub const m_nVerticalSize: usize = 0x794; // 
                pub const m_nMinDist: usize = 0x798; // 
                pub const m_nMaxDist: usize = 0x79C; // 
                pub const m_nOuterMaxDist: usize = 0x7A0; // 
                pub const m_flGlowProxySize: usize = 0x7A4; // 
                pub const m_flHDRColorScale: usize = 0x7A8; // 
            }
            // Parent: None
            // Field count: 13
            //
            ...
            pub mod CBasePropDoor {
                pub const m_flAutoReturnDelay: usize = 0xC68; // 
                pub const m_hDoorList: usize = 0xC70; // CUtlVector<CHandle<CBasePropDoor>>
                pub const m_nHardwareType: usize = 0xC88; // 
                pub const m_bNeedsHardware: usize = 0xC8C; // 
                pub const m_eDoorState: usize = 0xC90; // 
                pub const m_bLocked: usize = 0xC94; // 
                pub const m_closedPosition: usize = 0xC98; // 
                pub const m_closedAngles: usize = 0xCA4; // 
                pub const m_hBlocker: usize = 0xCB0; // 
                pub const m_bFirstBlocked: usize = 0xCB4; // 
                pub const m_ls: usize = 0xCB8; // 
                pub const m_bForceClosed: usize = 0xCD8; // 
                pub const m_vecLatchWorldPosition: usize = 0xCDC; // 
                ...
                pub const m_numCloseAttempts: usize = 0xD40; // 
                pub const m_nPhysicsMaterial: usize = 0xD44; // 
                pub const m_SlaveName: usize = 0xD48; // 
                pub const m_hMaster: usize = 0xD50; // 
                pub const m_OnBlockedClosing: usize = 0xD58; // 
                pub const m_OnBlockedOpening: usize = 0xD80; // 
                pub const m_OnUnblockedClosing: usize = 0xDA8; // 
                pub const m_OnUnblockedOpening: usize = 0xDD0; // 
                pub const m_OnFullyClosed: usize = 0xDF8; // 
                pub const m_OnFullyOpen: usize = 0xE20; // 
                pub const m_OnClose: usize = 0xE48; // 
                pub const m_OnOpen: usize = 0xE70; // 
                pub const m_OnLockedUse: usize = 0xE98; // 
                pub const m_OnAjarOpen: usize = 0xEC0; // 
            }
            // Parent: CBaseEntity
            // Field count: 4
            //
            ...
            pub mod CRagdollManager {
                ...
                pub const m_bCanTakeDamage: usize = 0x4E9; // 
            }
            // Parent: CBaseTrigger
            // Field count: 12
            pub mod CTriggerFan {
                pub const m_vFanOrigin: usize = 0x960; // 
                pub const m_vFanEnd: usize = 0x96C; // 
                pub const m_vNoise: usize = 0x978; // 
                pub const m_flForce: usize = 0x984; // 
                pub const m_flRopeForceScale: usize = 0x988; // 
                pub const m_flPlayerForce: usize = 0x98C; // 
                pub const m_flRampTime: usize = 0x990; // 
                pub const m_bFalloff: usize = 0x994; // 
                pub const m_bPushPlayer: usize = 0x995; // 
                pub const m_bRampDown: usize = 0x996; // 
                pub const m_bAddNoise: usize = 0x997; // 
            ...
            // Field count: 8
            pub mod CItem {
                pub const m_OnPlayerTouch: usize = 0x9B0; // 
                pub const m_OnPlayerPickup: usize = 0x9D8; // 
                pub const m_bActivateWhenAtRest: usize = 0xA00; // 
                pub const m_OnCacheInteraction: usize = 0xA08; // 
                pub const m_OnGlovePulled: usize = 0xA30; // 
                pub const m_vOriginalSpawnOrigin: usize = 0xA58; // 
                pub const m_vOriginalSpawnAngles: usize = 0xA64; // 
                pub const m_bPhysStartAsleep: usize = 0xA70; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 14
            //
            ...
            pub mod CBaseClientUIEntity {
                ...
                pub const m_CustomOutput0: usize = 0x7B0; // 
                pub const m_CustomOutput1: usize = 0x7D8; // 
                pub const m_CustomOutput2: usize = 0x800; // 
                pub const m_CustomOutput3: usize = 0x828; // 
                pub const m_CustomOutput4: usize = 0x850; // 
                pub const m_CustomOutput5: usize = 0x878; // 
                pub const m_CustomOutput6: usize = 0x8A0; // 
                pub const m_CustomOutput7: usize = 0x8C8; // 
                pub const m_CustomOutput8: usize = 0x8F0; // 
                pub const m_CustomOutput9: usize = 0x918; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 9
            //
            ...
            pub mod CEnvDecal {
                pub const m_hDecalMaterial: usize = 0x790; // 
                pub const m_flWidth: usize = 0x798; // 
                pub const m_flHeight: usize = 0x79C; // 
                pub const m_flDepth: usize = 0x7A0; // 
                pub const m_nRenderOrder: usize = 0x7A4; // 
                pub const m_bProjectOnWorld: usize = 0x7A8; // 
                pub const m_bProjectOnCharacters: usize = 0x7A9; // 
                pub const m_bProjectOnWater: usize = 0x7AA; // 
                pub const m_flDepthSortBias: usize = 0x7AC; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            pub mod CFuncTrackChange {
                ...
                pub const m_targetState: usize = 0x88C; // 
                pub const m_use: usize = 0x890; // 
            }
            // Parent: CRuleBrushEntity
            // Field count: 4
            pub mod CGamePlayerZone {
                pub const m_OnPlayerInZone: usize = 0x798; // 
                pub const m_OnPlayerOutZone: usize = 0x7C0; // 
            ...
            pub mod CBaseViewModel {
                pub const m_vecLastFacing: usize = 0x9B0; // 
                pub const m_nViewModelIndex: usize = 0x9BC; // 
                pub const m_nAnimationParity: usize = 0x9C0; // 
                pub const m_flAnimationStartTime: usize = 0x9C4; // 
                ...
                pub const m_oldLayer: usize = 0x9E4; // 
                pub const m_oldLayerStartTime: usize = 0x9E8; // 
            ...
            pub mod CTriggerActiveWeaponDetect {
                pub const m_OnTouchedActiveWeapon: usize = 0x960; // 
            ...
            // Field count: 1
            pub mod CKnife {
                pub const m_bFirstAttack: usize = 0xF58; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 37
            pub mod CFuncTrackTrain {
                pub const m_ppath: usize = 0x790; // 
                pub const m_length: usize = 0x794; // 
                pub const m_vPosPrev: usize = 0x798; // 
                pub const m_angPrev: usize = 0x7A4; // 
                pub const m_controlMins: usize = 0x7B0; // 
                pub const m_controlMaxs: usize = 0x7BC; // 
                pub const m_lastBlockPos: usize = 0x7C8; // 
                pub const m_lastBlockTick: usize = 0x7D4; // 
                pub const m_flVolume: usize = 0x7D8; // 
                pub const m_flBank: usize = 0x7DC; // 
                pub const m_oldSpeed: usize = 0x7E0; // 
                pub const m_flBlockDamage: usize = 0x7E4; // 
                pub const m_height: usize = 0x7E8; // 
                pub const m_maxSpeed: usize = 0x7EC; // 
                pub const m_dir: usize = 0x7F0; // 
                ...
                pub const m_flMoveSoundMinDuration: usize = 0x820; // 
                pub const m_flMoveSoundMaxDuration: usize = 0x824; // 
                pub const m_flNextMoveSoundTime: usize = 0x828; // 
                pub const m_flMoveSoundMinPitch: usize = 0x82C; // 
                pub const m_flMoveSoundMaxPitch: usize = 0x830; // 
                pub const m_eOrientationType: usize = 0x834; // 
                pub const m_eVelocityType: usize = 0x838; // 
                pub const m_OnStart: usize = 0x848; // 
                pub const m_OnNext: usize = 0x870; // 
                pub const m_OnArrivedAtDestinationNode: usize = 0x898; // 
                pub const m_bManualSpeedChanges: usize = 0x8C0; // 
                pub const m_flDesiredSpeed: usize = 0x8C4; // 
                pub const m_flSpeedChangeTime: usize = 0x8C8; // 
                pub const m_flAccelSpeed: usize = 0x8CC; // 
                pub const m_flDecelSpeed: usize = 0x8D0; // 
                pub const m_bAccelToSpeed: usize = 0x8D4; // 
                pub const m_flNextMPSoundTime: usize = 0x8D8; // 
            }
            ...
            pub mod CFogVolume {
                ...
                pub const m_bDisabled: usize = 0x7B0; // 
                pub const m_bInFogVolumesList: usize = 0x7B1; // 
            }
            // Parent: SpawnPoint
            // Field count: 0
            ...
            pub mod CFire {
                ...
                pub const m_nFireType: usize = 0x798; // 
                pub const m_flFuel: usize = 0x79C; // 
                pub const m_flDamageTime: usize = 0x7A0; // 
                pub const m_lastDamage: usize = 0x7A4; // 
                pub const m_flFireSize: usize = 0x7A8; // 
                pub const m_flLastNavUpdateTime: usize = 0x7AC; // 
                pub const m_flHeatLevel: usize = 0x7B0; // 
                pub const m_flHeatAbsorb: usize = 0x7B4; // 
                pub const m_flDamageScale: usize = 0x7B8; // 
                pub const m_flMaxHeat: usize = 0x7BC; // 
                pub const m_flLastHeatLevel: usize = 0x7C0; // 
                pub const m_flAttackTime: usize = 0x7C4; // 
                pub const m_bEnabled: usize = 0x7C8; // 
                pub const m_bStartDisabled: usize = 0x7C9; // 
                pub const m_bDidActivate: usize = 0x7CA; // 
                pub const m_OnIgnited: usize = 0x7D0; // 
                pub const m_OnExtinguished: usize = 0x7F8; // 
            }
            ...
            pub mod CBaseAnimGraph {
                pub const m_bInitiallyPopulateInterpHistory: usize = 0x808; // 
                pub const m_pChoreoServices: usize = 0x810; // 
                pub const m_bAnimGraphUpdateEnabled: usize = 0x818; // 
                pub const m_flMaxSlopeDistance: usize = 0x81C; // 
                pub const m_vLastSlopeCheckPos: usize = 0x820; // 
                pub const m_bAnimationUpdateScheduled: usize = 0x82C; // 
                pub const m_vecForce: usize = 0x830; // 
                pub const m_nForceBone: usize = 0x83C; // 
                pub const m_RagdollPose: usize = 0x850; // 
                pub const m_bRagdollClientSide: usize = 0x878; // 
                pub const m_nLastDestructiblePartDestroyedAnimgraphSetTick: usize = 0x9A0; // 
            }
            // Parent: CPhysForce
            // Field count: 1
            pub mod CPhysTorque {
            ...
            pub mod CRagdollProp {
                ...
                pub const m_bStartDisabled: usize = 0x9E8; // 
                pub const m_ragPos: usize = 0x9F0; // 
                pub const m_ragAngles: usize = 0xA08; // 
                pub const m_hRagdollSource: usize = 0xA20; // 
                pub const m_lastUpdateTickCount: usize = 0xA24; // 
                pub const m_allAsleep: usize = 0xA28; // 
                pub const m_bFirstCollisionAfterLaunch: usize = 0xA29; // 
                pub const m_hDamageEntity: usize = 0xA2C; // 
                pub const m_hKiller: usize = 0xA30; // 
                pub const m_hPhysicsAttacker: usize = 0xA34; // 
                pub const m_flLastPhysicsInfluenceTime: usize = 0xA38; // 
                pub const m_flFadeOutStartTime: usize = 0xA3C; // 
                pub const m_flFadeTime: usize = 0xA40; // 
                pub const m_vecLastOrigin: usize = 0xA44; // 
                pub const m_flAwakeTime: usize = 0xA50; // 
                pub const m_flLastOriginChangeTime: usize = 0xA54; // 
                pub const m_strOriginClassName: usize = 0xA58; // 
                pub const m_strSourceClassName: usize = 0xA60; // 
                pub const m_bHasBeenPhysgunned: usize = 0xA68; // 
                pub const m_bShouldTeleportPhysics: usize = 0xA69; // 
                pub const m_flBlendWeight: usize = 0xA6C; // 
                pub const m_flDefaultFadeScale: usize = 0xA70; // 
                pub const m_ragdollMins: usize = 0xA78; // 
                pub const m_ragdollMaxs: usize = 0xA90; // 
                pub const m_bShouldDeleteActivationRecord: usize = 0xAA8; // 
                pub const m_bValidatePoweredRagdollPose: usize = 0xB08; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 0
            pub mod CItemSoda {
            ...
            pub mod CTriggerLook {
                ...
                pub const m_flFieldOfView: usize = 0x98C; // 
                pub const m_flLookTime: usize = 0x990; // 
                pub const m_flLookTimeTotal: usize = 0x994; // 
                pub const m_flLookTimeLast: usize = 0x998; // 
                pub const m_flTimeoutDuration: usize = 0x99C; // 
                pub const m_bTimeoutFired: usize = 0x9A0; // 
                pub const m_bIsLooking: usize = 0x9A1; // 
                pub const m_b2DFOV: usize = 0x9A2; // 
                pub const m_bUseVelocity: usize = 0x9A3; // 
                pub const m_bTestOcclusion: usize = 0x9A4; // 
                pub const m_OnTimeout: usize = 0x9A8; // 
                pub const m_OnStartLook: usize = 0x9D0; // 
                pub const m_OnEndLook: usize = 0x9F8; // 
            }
            // Parent: CPointEntity
            // Field count: 0
            ...
            pub mod CParticleSystem {
                ...
                pub const m_bActive: usize = 0x990; // 
                pub const m_bFrozen: usize = 0x991; // 
                pub const m_flFreezeTransitionDuration: usize = 0x994; // 
                pub const m_nStopType: usize = 0x998; // 
                pub const m_bAnimateDuringGameplayPause: usize = 0x99C; // 
                pub const m_iEffectIndex: usize = 0x9A0; // 
                pub const m_flStartTime: usize = 0x9A8; // 
                pub const m_flPreSimTime: usize = 0x9AC; // 
                pub const m_vServerControlPoints: usize = 0x9B0; // 
                pub const m_iServerControlPointAssignments: usize = 0x9E0; // 
                pub const m_hControlPointEnts: usize = 0x9E4; // 
                pub const m_bNoSave: usize = 0xAE4; // 
                pub const m_bNoFreeze: usize = 0xAE5; // 
                pub const m_bNoRamp: usize = 0xAE6; // 
                pub const m_bStartActive: usize = 0xAE7; // 
                pub const m_iszEffectName: usize = 0xAE8; // 
                pub const m_iszControlPointNames: usize = 0xAF0; // 
                pub const m_nDataCP: usize = 0xCF0; // 
                pub const m_vecDataCPValue: usize = 0xCF4; // 
                pub const m_nTintCP: usize = 0xD00; // 
                pub const m_clrTint: usize = 0xD04; // 
            }
            ...
            pub mod CDynamicLight {
                pub const m_ActualFlags: usize = 0x790; // 
                pub const m_Flags: usize = 0x791; // 
                pub const m_LightStyle: usize = 0x792; // 
                pub const m_On: usize = 0x793; // 
                pub const m_Radius: usize = 0x794; // 
                pub const m_Exponent: usize = 0x798; // 
                pub const m_InnerAngle: usize = 0x79C; // 
                pub const m_OuterAngle: usize = 0x7A0; // 
                pub const m_SpotRadius: usize = 0x7A4; // 
            }
            // Parent: CCSWeaponBaseGun
            // Field count: 0
            pub mod CWeaponP90 {
            ...
            pub mod CPhysicsProp {
                pub const m_MotionEnabled: usize = 0xB60; // 
                pub const m_OnAwakened: usize = 0xB88; // 
                pub const m_OnAwake: usize = 0xBB0; // 
                pub const m_OnAsleep: usize = 0xBD8; // 
                pub const m_OnPlayerUse: usize = 0xC00; // 
                pub const m_OnOutOfWorld: usize = 0xC28; // 
                pub const m_OnPlayerPickup: usize = 0xC50; // 
                pub const m_bForceNavIgnore: usize = 0xC78; // 
                pub const m_bNoNavmeshBlocker: usize = 0xC79; // 
                pub const m_bForceNpcExclude: usize = 0xC7A; // 
                pub const m_massScale: usize = 0xC7C; // 
                pub const m_inertiaScale: usize = 0xC80; // 
                pub const m_buoyancyScale: usize = 0xC84; // 
                pub const m_damageType: usize = 0xC88; // 
                pub const m_damageToEnableMotion: usize = 0xC8C; // 
                pub const m_flForceToEnableMotion: usize = 0xC90; // 
                pub const m_bThrownByPlayer: usize = 0xC94; // 
                pub const m_bDroppedByPlayer: usize = 0xC95; // 
                pub const m_bTouchedByPlayer: usize = 0xC96; // 
                pub const m_bFirstCollisionAfterLaunch: usize = 0xC97; // 
                pub const m_iExploitableByPlayer: usize = 0xC98; // 
                pub const m_bHasBeenAwakened: usize = 0xC9C; // 
                pub const m_bIsOverrideProp: usize = 0xC9D; // 
                pub const m_fNextCheckDisableMotionContactsTime: usize = 0xCA0; // 
                pub const m_iInitialGlowState: usize = 0xCA4; // 
                pub const m_nGlowRange: usize = 0xCA8; // 
                pub const m_nGlowRangeMin: usize = 0xCAC; // 
                pub const m_glowColor: usize = 0xCB0; // 
                pub const m_bShouldAutoConvertBackFromDebris: usize = 0xCB4; // 
                pub const m_bMuteImpactEffects: usize = 0xCB5; // 
                pub const m_bAcceptDamageFromHeldObjects: usize = 0xCBF; // 
                pub const m_bEnableUseOutput: usize = 0xCC0; // 
                pub const m_CrateType: usize = 0xCC4; // 
                pub const m_strItemClass: usize = 0xCC8; // 
                pub const m_nItemCount: usize = 0xCE8; // 
                pub const m_bRemovableForAmmoBalancing: usize = 0xCF8; // 
                pub const m_bAwake: usize = 0xCF9; // 
            }
            // Parent: CFuncWall
            // Field count: 0
            ...
            pub mod CSensorGrenadeProjectile {
                pub const m_fExpireTime: usize = 0xB50; // 
                pub const m_fNextDetectPlayerSound: usize = 0xB54; // 
            ...
            pub mod CTriggerSndSosOpvar {
                ...
                pub const m_flPosition: usize = 0x978; // 
                pub const m_flCenterSize: usize = 0x984; // 
                pub const m_flMinVal: usize = 0x988; // 
                pub const m_flMaxVal: usize = 0x98C; // 
                pub const m_opvarName: usize = 0x990; // 
                pub const m_stackName: usize = 0x998; // 
                pub const m_operatorName: usize = 0x9A0; // 
                pub const m_bVolIs2D: usize = 0x9A8; // 
                pub const m_opvarNameChar: usize = 0x9A9; // 
                pub const m_stackNameChar: usize = 0xAA9; // 
                pub const m_operatorNameChar: usize = 0xBA9; // 
                pub const m_VecNormPos: usize = 0xCAC; // 
                pub const m_flNormCenterSize: usize = 0xCB8; // 
            }
            // Parent: CItem
            // Field count: 0
            ...
            pub mod CEnvProjectedTexture {
                ...
                pub const m_bState: usize = 0x794; // 
                pub const m_bAlwaysUpdate: usize = 0x795; // 
                pub const m_flLightFOV: usize = 0x798; // 
                pub const m_bEnableShadows: usize = 0x79C; // 
                pub const m_bSimpleProjection: usize = 0x79D; // 
                pub const m_bLightOnlyTarget: usize = 0x79E; // 
                pub const m_bLightWorld: usize = 0x79F; // 
                pub const m_bCameraSpace: usize = 0x7A0; // 
                pub const m_flBrightnessScale: usize = 0x7A4; // 
                pub const m_LightColor: usize = 0x7A8; // 
                pub const m_flIntensity: usize = 0x7AC; // 
                pub const m_flLinearAttenuation: usize = 0x7B0; // 
                pub const m_flQuadraticAttenuation: usize = 0x7B4; // 
                pub const m_bVolumetric: usize = 0x7B8; // 
                pub const m_flNoiseStrength: usize = 0x7BC; // 
                pub const m_flFlashlightTime: usize = 0x7C0; // 
                pub const m_nNumPlanes: usize = 0x7C4; // 
                pub const m_flPlaneOffset: usize = 0x7C8; // 
                pub const m_flVolumetricIntensity: usize = 0x7CC; // 
                pub const m_flColorTransitionTime: usize = 0x7D0; // 
                pub const m_flAmbient: usize = 0x7D4; // 
                pub const m_SpotlightTextureName: usize = 0x7D8; // 
                pub const m_nSpotlightTextureFrame: usize = 0x9D8; // 
                pub const m_nShadowQuality: usize = 0x9DC; // 
                pub const m_flNearZ: usize = 0x9E0; // 
                pub const m_flFarZ: usize = 0x9E4; // 
                pub const m_flProjectionSize: usize = 0x9E8; // 
                pub const m_flRotation: usize = 0x9EC; // 
                pub const m_bFlipHorizontal: usize = 0x9F0; // 
            }
            // Parent: CDynamicProp
            // Field count: 0
            ...
            pub mod CBasePlatTrain {
                ...
                pub const m_volume: usize = 0x828; // 
                pub const m_flTWidth: usize = 0x82C; // 
                pub const m_flTLength: usize = 0x830; // 
            }
            ...
            // Field count: 1
            pub mod CFuncWater {
                pub const m_BuoyancyHelper: usize = 0x790; // 
            }
            // Parent: CBaseEntity
            // Field count: 5
            ...
            // Field count: 4
            pub mod CGameMoney {
                pub const m_OnMoneySpent: usize = 0x7A0; // 
                pub const m_OnMoneySpentFail: usize = 0x7C8; // 
                pub const m_nMoney: usize = 0x7F0; // 
                pub const m_strAwardText: usize = 0x7F8; // 
            }
            // Parent: CLogicalEntity
            // Field count: 5
            ...
            pub mod CEnvParticleGlow {
                pub const m_flAlphaScale: usize = 0xD08; // 
                pub const m_flRadiusScale: usize = 0xD0C; // 
                pub const m_flSelfIllumScale: usize = 0xD10; // 
                pub const m_ColorTint: usize = 0xD14; // 
                pub const m_hTextureOverride: usize = 0xD18; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 0
            ...
            pub mod CFuncMonitor {
                pub const m_targetCamera: usize = 0x7B0; // 
                pub const m_nResolutionEnum: usize = 0x7B8; // 
                pub const m_bRenderShadows: usize = 0x7BC; // 
                pub const m_bUseUniqueColorTarget: usize = 0x7BD; // 
                pub const m_brushModelName: usize = 0x7C0; // 
                pub const m_hTargetCamera: usize = 0x7C8; // 
                pub const m_bEnabled: usize = 0x7CC; // 
                pub const m_bDraw3DSkybox: usize = 0x7CD; // 
                pub const m_bStartEnabled: usize = 0x7CE; // 
            }
            // Parent: CBaseEntity
            // Field count: 0
            pub mod CEnvFunnel {
            ...
            pub mod CMolotovProjectile {
                pub const m_bIsIncGrenade: usize = 0xB50; // 
                pub const m_bDetonated: usize = 0xB5C; // 
                pub const m_stillTimer: usize = 0xB60; // 
                pub const m_bHasBouncedOffPlayer: usize = 0xC40; // 
            }
            // Parent: CBaseTrigger
            // Field count: 0
            ...
            pub mod CFuncLadder {
                pub const m_vecLadderDir: usize = 0x790; // 
                pub const m_Dismounts: usize = 0x7A0; // CUtlVector<CHandle<CInfoLadderDismount>>
                pub const m_vecLocalTop: usize = 0x7B8; // 
                pub const m_vecPlayerMountPositionTop: usize = 0x7C4; // 
                pub const m_vecPlayerMountPositionBottom: usize = 0x7D0; // 
                pub const m_flAutoRideSpeed: usize = 0x7DC; // 
                pub const m_bDisabled: usize = 0x7E0; // 
                pub const m_bFakeLadder: usize = 0x7E1; // 
                pub const m_bHasSlack: usize = 0x7E2; // 
                pub const m_surfacePropName: usize = 0x7E8; // 
                pub const m_OnPlayerGotOnLadder: usize = 0x7F0; // 
                pub const m_OnPlayerGotOffLadder: usize = 0x818; // 
            }
            // Parent: CLogicalEntity
            // Field count: 8
            ...
            pub mod CPlayerSprayDecal {
                pub const m_nUniqueID: usize = 0x790; // 
                pub const m_unAccountID: usize = 0x794; // 
                pub const m_unTraceID: usize = 0x798; // 
                pub const m_rtGcTime: usize = 0x79C; // 
                pub const m_vecEndPos: usize = 0x7A0; // 
                pub const m_vecStart: usize = 0x7AC; // 
                pub const m_vecLeft: usize = 0x7B8; // 
                pub const m_vecNormal: usize = 0x7C4; // 
                pub const m_nPlayer: usize = 0x7D0; // 
                pub const m_nEntity: usize = 0x7D4; // 
                pub const m_nHitbox: usize = 0x7D8; // 
                pub const m_flCreationTime: usize = 0x7DC; // 
                pub const m_nTintID: usize = 0x7E0; // 
                pub const m_nVersion: usize = 0x7E4; // 
            ...
            pub mod CBombTarget {
                pub const m_OnBombExplode: usize = 0x960; // 
                pub const m_OnBombPlanted: usize = 0x988; // 
                pub const m_OnBombDefused: usize = 0x9B0; // 
                pub const m_bIsBombSiteB: usize = 0x9D8; // 
                pub const m_bIsHeistBombTarget: usize = 0x9D9; // 
                pub const m_bBombPlantedHere: usize = 0x9DA; // 
                pub const m_szMountTarget: usize = 0x9E0; // 
                pub const m_hInstructorHint: usize = 0x9E8; // 
                pub const m_nBombSiteDesignation: usize = 0x9EC; // 
            }
            // Parent: CBaseEntity
            // Field count: 8
            ...
            pub mod CScriptTriggerPush {
                pub const m_vExtent: usize = 0x998; // 
            }
            // Parent: CBaseEntity
            // Field count: 1
            ...
            // Field count: 1
            pub mod CFuncWall {
                pub const m_nState: usize = 0x790; // 
            }
            // Parent: CPointEntity
            // Field count: 1
            ...
            pub mod CSmokeGrenadeProjectile {
                pub const m_nSmokeEffectTickBegin: usize = 0xB68; // 
                pub const m_bDidSmokeEffect: usize = 0xB6C; // 
                pub const m_nRandomSeed: usize = 0xB70; // 
                pub const m_vSmokeColor: usize = 0xB74; // 
                pub const m_vSmokeDetonationPos: usize = 0xB80; // 
                pub const m_VoxelFrameData: usize = 0xB90; // 
                pub const m_flLastBounce: usize = 0xBA8; // 
                pub const m_fllastSimulationTime: usize = 0xBAC; // 
                pub const m_bExplodeFromInferno: usize = 0x2E30; // 
            }
            // Parent: CTriggerMultiple
            // Field count: 1
            pub mod CScriptTriggerMultiple {
                pub const m_vExtent: usize = 0x988; // 
            }
            ...
            pub mod CTriggerHurt {
                pub const m_flOriginalDamage: usize = 0x960; // 
                pub const m_flDamage: usize = 0x964; // 
                pub const m_flDamageCap: usize = 0x968; // 
                pub const m_flLastDmgTime: usize = 0x96C; // 
                pub const m_flForgivenessDelay: usize = 0x970; // 
                pub const m_bitsDamageInflict: usize = 0x974; // 
                pub const m_damageModel: usize = 0x978; // 
                pub const m_bNoDmgForce: usize = 0x97C; // 
                pub const m_vDamageForce: usize = 0x980; // 
                pub const m_thinkAlways: usize = 0x98C; // 
                pub const m_hurtThinkPeriod: usize = 0x990; // 
                pub const m_OnHurt: usize = 0x998; // 
                pub const m_OnHurtPlayer: usize = 0x9C0; // 
            ...
            pub mod CTriggerSave {
                pub const m_bForceNewLevelUnit: usize = 0x960; // 
                pub const m_fDangerousTimer: usize = 0x964; // 
                pub const m_minHitPoints: usize = 0x968; // 
            }
            // Parent: CPhysConstraint
            // Field count: 11
            ...
            pub mod CEnvLaser {
                ...
                pub const m_firePosition: usize = 0x848; // 
                pub const m_flStartFrame: usize = 0x854; // 
            }
            // Parent: CSprite
            // Field count: 0
            ...
            pub mod CBasePlayerWeapon {
                pub const m_nNextPrimaryAttackTick: usize = 0xD30; // 
                pub const m_flNextPrimaryAttackTickRatio: usize = 0xD34; // 
                pub const m_nNextSecondaryAttackTick: usize = 0xD38; // 
                pub const m_flNextSecondaryAttackTickRatio: usize = 0xD3C; // 
                pub const m_iClip1: usize = 0xD40; // 
                pub const m_iClip2: usize = 0xD44; // 
                pub const m_pReserveAmmo: usize = 0xD48; // 
                pub const m_OnPlayerUse: usize = 0xD50; // 
            }
            // Parent: CPlayerControllerComponent
            // Field count: 5
            //
            ...
            pub mod CFish {
                ...
                pub const m_id: usize = 0x9AC; // 
                pub const m_x: usize = 0x9B0; // 
                pub const m_y: usize = 0x9B4; // 
                pub const m_z: usize = 0x9B8; // 
                pub const m_angle: usize = 0x9BC; // 
                pub const m_angleChange: usize = 0x9C0; // 
                pub const m_forward: usize = 0x9C4; // 
                pub const m_perp: usize = 0x9D0; // 
                pub const m_poolOrigin: usize = 0x9DC; // 
                pub const m_waterLevel: usize = 0x9E8; // 
                pub const m_speed: usize = 0x9EC; // 
                pub const m_desiredSpeed: usize = 0x9F0; // 
                pub const m_calmSpeed: usize = 0x9F4; // 
                pub const m_panicSpeed: usize = 0x9F8; // 
                pub const m_avoidRange: usize = 0x9FC; // 
                pub const m_turnTimer: usize = 0xA00; // 
                pub const m_turnClockwise: usize = 0xA18; // 
                ...
                pub const m_visible: usize = 0xA98; // 
            }
            // Parent: CBaseEntity
            // Field count: 3
            ...
            pub mod CTriggerGameEvent {
                pub const m_strStartTouchEventName: usize = 0x960; // 
                pub const m_strEndTouchEventName: usize = 0x968; // 
                pub const m_strTriggerID: usize = 0x970; // 
            }
            // Parent: CPhysConstraint
            // Field count: 10
            ...
            pub mod CFuncRotating {
                pub const m_OnStopped: usize = 0x790; // 
                pub const m_OnStarted: usize = 0x7B8; // 
                pub const m_OnReachedStart: usize = 0x7E0; // 
                pub const m_localRotationVector: usize = 0x808; // 
                pub const m_flFanFriction: usize = 0x814; // 
                pub const m_flAttenuation: usize = 0x818; // 
                pub const m_flVolume: usize = 0x81C; // 
                pub const m_flTargetSpeed: usize = 0x820; // 
                pub const m_flMaxSpeed: usize = 0x824; // 
                pub const m_flBlockDamage: usize = 0x828; // 
                pub const m_NoiseRunning: usize = 0x830; // 
                pub const m_bReversed: usize = 0x838; // 
                pub const m_bAccelDecel: usize = 0x839; // 
                pub const m_prevLocalAngles: usize = 0x844; // 
                pub const m_angStart: usize = 0x850; // 
                pub const m_bStopAtStartPos: usize = 0x85C; // 
                pub const m_vecClientOrigin: usize = 0x860; // 
                pub const m_vecClientAngles: usize = 0x86C; // 
            }
            // Parent: CBaseGrenade
            // Field count: 17
            //
            ...
            pub mod CBaseCSGrenadeProjectile {
                pub const m_vInitialPosition: usize = 0xAE0; // 
                pub const m_vInitialVelocity: usize = 0xAEC; // 
                pub const m_nBounces: usize = 0xAF8; // 
                pub const m_nExplodeEffectIndex: usize = 0xB00; // 
                pub const m_nExplodeEffectTickBegin: usize = 0xB08; // 
                pub const m_vecExplodeEffectOrigin: usize = 0xB0C; // 
                pub const m_flSpawnTime: usize = 0xB18; // 
                pub const m_unOGSExtraFlags: usize = 0xB1C; // 
                pub const m_bDetonationRecorded: usize = 0xB1D; // 
                pub const m_nItemIndex: usize = 0xB1E; // 
                pub const m_vecOriginalSpawnLocation: usize = 0xB20; // 
                pub const m_flLastBounceSoundTime: usize = 0xB2C; // 
                pub const m_vecGrenadeSpin: usize = 0xB30; // 
                pub const m_vecLastHitSurfaceNormal: usize = 0xB3C; // 
                pub const m_nTicksAtZeroVelocity: usize = 0xB48; // 
                pub const m_bHasEverHitPlayer: usize = 0xB4C; // 
                pub const m_bClearFromPlayers: usize = 0xB4D; // 
            }
            // Parent: CServerOnlyModelEntity
            // Field count: 1
            pub mod CCSPlace {
            ...
            pub mod CEntityDissolve {
                pub const m_flFadeInStart: usize = 0x790; // 
                pub const m_flFadeInLength: usize = 0x794; // 
                pub const m_flFadeOutModelStart: usize = 0x798; // 
                pub const m_flFadeOutModelLength: usize = 0x79C; // 
                pub const m_flFadeOutStart: usize = 0x7A0; // 
                pub const m_flFadeOutLength: usize = 0x7A4; // 
                pub const m_flStartTime: usize = 0x7A8; // 
                pub const m_nDissolveType: usize = 0x7AC; // 
                pub const m_vDissolverOrigin: usize = 0x7B0; // 
                pub const m_nMagnitude: usize = 0x7BC; // 
            }
            // Parent: CPointEntity
            // Field count: 12
            ...
            // NetworkVarNames: m_vecEndPos (Vector)
            pub mod CBeam {
                pub const m_flFrameRate: usize = 0x790; // 
                pub const m_flHDRColorScale: usize = 0x794; // 
                pub const m_flFireTime: usize = 0x798; // 
                pub const m_flDamage: usize = 0x79C; // 
                pub const m_nNumBeamEnts: usize = 0x7A0; // 
                pub const m_hBaseMaterial: usize = 0x7A8; // 
                pub const m_nHaloIndex: usize = 0x7B0; // 
                pub const m_nBeamType: usize = 0x7B8; // 
                pub const m_nBeamFlags: usize = 0x7BC; // 
                pub const m_hAttachEntity: usize = 0x7C0; // 
                pub const m_nAttachIndex: usize = 0x7E8; // 
                pub const m_fWidth: usize = 0x7F4; // 
                pub const m_fEndWidth: usize = 0x7F8; // 
                pub const m_fFadeLength: usize = 0x7FC; // 
                pub const m_fHaloScale: usize = 0x800; // 
                pub const m_fAmplitude: usize = 0x804; // 
                pub const m_fStartFrame: usize = 0x808; // 
                pub const m_fSpeed: usize = 0x80C; // 
                pub const m_flFrame: usize = 0x810; // 
                pub const m_nClipStyle: usize = 0x814; // 
                pub const m_bTurnedOff: usize = 0x818; // 
                pub const m_vecEndPos: usize = 0x81C; // 
                pub const m_hEndEntity: usize = 0x828; // 
                pub const m_nDissolveType: usize = 0x82C; // 
            }
            // Parent: CBaseEntity
            // Field count: 33
            //
            ...
            pub mod CBaseModelEntity {
                ...
                pub const m_nDestructiblePartInitialStateDestructed0: usize = 0x510; // 
                pub const m_nDestructiblePartInitialStateDestructed1: usize = 0x514; // 
                pub const m_nDestructiblePartInitialStateDestructed2: usize = 0x518; // 
                pub const m_nDestructiblePartInitialStateDestructed3: usize = 0x51C; // 
                pub const m_nDestructiblePartInitialStateDestructed4: usize = 0x520; // 
                pub const m_nLastHitDestructiblePartIndex: usize = 0x524; // 
                pub const m_LastHitGroup: usize = 0x550; // 
                pub const m_flDissolveStartTime: usize = 0x554; // 
                pub const m_OnIgnite: usize = 0x558; // 
                pub const m_nRenderMode: usize = 0x580; // 
                pub const m_nRenderFX: usize = 0x581; // 
                pub const m_bAllowFadeInView: usize = 0x582; // 
                pub const m_clrRender: usize = 0x5A0; // 
                pub const m_vecRenderAttributes: usize = 0x5A8; // 
                pub const m_bRenderToCubemaps: usize = 0x5F8; // 
                pub const m_bNoInterpolate: usize = 0x5F9; // 
                pub const m_Collision: usize = 0x600; // 
                ...
                pub const m_nAddDecal: usize = 0x720; // 
                pub const m_vDecalPosition: usize = 0x724; // 
                pub const m_vDecalForwardAxis: usize = 0x730; // 
                pub const m_flDecalHealBloodRate: usize = 0x73C; // 
                pub const m_flDecalHealHeightRate: usize = 0x740; // 
                pub const m_ConfigEntitiesToPropagateMaterialDecalsTo: usize = 0x748; // 
                pub const m_vecViewOffset: usize = 0x760; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 12
            pub mod CPhysMagnet {
                pub const m_OnMagnetAttach: usize = 0x9A8; // 
                pub const m_OnMagnetDetach: usize = 0x9D0; // 
                pub const m_massScale: usize = 0x9F8; // 
                pub const m_forceLimit: usize = 0x9FC; // 
                pub const m_torqueLimit: usize = 0xA00; // 
                pub const m_MagnettedEntities: usize = 0xA08; // CUtlVector<magnetted_objects_t>
                pub const m_bActive: usize = 0xA20; // 
                pub const m_bHasHitSomething: usize = 0xA21; // 
                pub const m_flTotalMass: usize = 0xA24; // 
                pub const m_flRadius: usize = 0xA28; // 
                pub const m_flNextSuckTime: usize = 0xA2C; // 
                pub const m_iMaxObjectsAttached: usize = 0xA30; // 
            }
            // Parent: CSceneEntity
            // Field count: 0
            ...
            pub mod CFuncNavBlocker {
                pub const m_bDisabled: usize = 0x790; // 
                pub const m_nBlockedTeamNumber: usize = 0x794; // 
            }
            // Parent: CPointEntity
            // Field count: 4
            ...
            // Field count: 6
            pub mod CFuncBrush {
                pub const m_iSolidity: usize = 0x790; // 
                pub const m_iDisabled: usize = 0x794; // 
                pub const m_bSolidBsp: usize = 0x798; // 
                pub const m_iszExcludedClass: usize = 0x7A0; // 
                pub const m_bInvertExclusion: usize = 0x7A8; // 
                pub const m_bScriptedMovement: usize = 0x7A9; // 
            }
            // Parent: CPointEntity
            // Field count: 3
            ...
            // Field count: 14
            pub mod CPhysBox {
                pub const m_damageType: usize = 0x868; // 
                pub const m_damageToEnableMotion: usize = 0x86C; // 
                pub const m_flForceToEnableMotion: usize = 0x870; // 
                pub const m_angPreferredCarryAngles: usize = 0x874; // 
                pub const m_bNotSolidToWorld: usize = 0x880; // 
                pub const m_bEnableUseOutput: usize = 0x881; // 
                pub const m_iExploitableByPlayer: usize = 0x884; // 
                pub const m_flTouchOutputPerEntityDelay: usize = 0x888; // 
                pub const m_OnDamaged: usize = 0x890; // 
                pub const m_OnAwakened: usize = 0x8B8; // 
                pub const m_OnMotionEnabled: usize = 0x8E0; // 
                pub const m_OnPlayerUse: usize = 0x908; // 
                pub const m_OnStartTouch: usize = 0x930; // 
            ...
            pub mod CBaseGrenade {
                pub const m_OnPlayerPickup: usize = 0xA40; // 
                pub const m_OnExplode: usize = 0xA68; // 
                pub const m_bHasWarnedAI: usize = 0xA90; // 
                pub const m_bIsSmokeGrenade: usize = 0xA91; // 
                pub const m_bIsLive: usize = 0xA92; // 
                pub const m_DmgRadius: usize = 0xA94; // 
                pub const m_flDetonateTime: usize = 0xA98; // 
                pub const m_flWarnAITime: usize = 0xA9C; // 
                pub const m_flDamage: usize = 0xAA0; // 
                pub const m_iszBounceSound: usize = 0xAA8; // 
                pub const m_ExplosionSound: usize = 0xAB0; // 
                pub const m_hThrower: usize = 0xABC; // 
                pub const m_flNextAttack: usize = 0xAD4; // 
                pub const m_hOriginalThrower: usize = 0xAD8; // 
            }
            // Parent: CLogicalEntity
            // Field count: 13
            ...
            pub mod CCSWeaponBase {
                pub const m_bRemoveable: usize = 0xDA0; // 
                pub const m_flFireSequenceStartTime: usize = 0xDA8; // 
                pub const m_nFireSequenceStartTimeChange: usize = 0xDAC; // 
                pub const m_nFireSequenceStartTimeAck: usize = 0xDB0; // 
                pub const m_ePlayerFireEvent: usize = 0xDB4; // 
                pub const m_ePlayerFireEventAttackType: usize = 0xDB8; // 
                ...
                pub const m_nSilencerBoneIndex: usize = 0xDE4; // 
                pub const m_thirdPersonSequences: usize = 0xDE8; // 
                pub const m_bPlayerAmmoStockOnPickup: usize = 0xE10; // 
                pub const m_bRequireUseToTouch: usize = 0xE11; // 
                pub const m_iState: usize = 0xE14; // 
                pub const m_flLastTimeInAir: usize = 0xE18; // 
                pub const m_flLastDeployTime: usize = 0xE1C; // 
                pub const m_nLastEmptySoundCmdNum: usize = 0xE20; // 
                pub const m_nViewModelIndex: usize = 0xE24; // 
                pub const m_bReloadsWithClips: usize = 0xE28; // 
                pub const m_flTimeWeaponIdle: usize = 0xE48; // 
                pub const m_bFireOnEmpty: usize = 0xE4C; // 
                pub const m_OnPlayerPickup: usize = 0xE50; // 
                pub const m_weaponMode: usize = 0xE78; // 
                pub const m_flTurningInaccuracyDelta: usize = 0xE7C; // 
                pub const m_vecTurningInaccuracyEyeDirLast: usize = 0xE80; // 
                pub const m_flTurningInaccuracy: usize = 0xE8C; // 
                pub const m_fAccuracyPenalty: usize = 0xE90; // 
                pub const m_flLastAccuracyUpdateTime: usize = 0xE94; // 
                pub const m_fAccuracySmoothedForZoom: usize = 0xE98; // 
                pub const m_fScopeZoomEndTime: usize = 0xE9C; // 
                pub const m_iRecoilIndex: usize = 0xEA0; // 
                pub const m_flRecoilIndex: usize = 0xEA4; // 
                pub const m_bBurstMode: usize = 0xEA8; // 
                pub const m_nPostponeFireReadyTicks: usize = 0xEAC; // 
                pub const m_flPostponeFireReadyFrac: usize = 0xEB0; // 
                pub const m_bInReload: usize = 0xEB4; // 
                pub const m_bReloadVisuallyComplete: usize = 0xEB5; // 
                pub const m_flDroppedAtTime: usize = 0xEB8; // 
                pub const m_bIsHauledBack: usize = 0xEBC; // 
                pub const m_bSilencerOn: usize = 0xEBD; // 
                pub const m_flTimeSilencerSwitchComplete: usize = 0xEC0; // 
                pub const m_iOriginalTeamNumber: usize = 0xEC4; // 
                pub const m_iMostRecentTeamNumber: usize = 0xEC8; // 
                pub const m_bDroppedNearBuyZone: usize = 0xECC; // 
                pub const m_flNextAttackRenderTimeOffset: usize = 0xED0; // 
                pub const m_bCanBePickedUp: usize = 0xEE8; // 
                pub const m_bUseCanOverrideNextOwnerTouchTime: usize = 0xEE9; // 
                pub const m_nextOwnerTouchTime: usize = 0xEEC; // 
                pub const m_nextPrevOwnerTouchTime: usize = 0xEF0; // 
                pub const m_hPrevOwner: usize = 0xEF8; // 
                pub const m_nDropTick: usize = 0xEFC; // 
                pub const m_donated: usize = 0xF1C; // 
                pub const m_fLastShotTime: usize = 0xF20; // 
                pub const m_bWasOwnedByCT: usize = 0xF24; // 
                pub const m_bWasOwnedByTerrorist: usize = 0xF25; // 
                pub const m_bFiredOutOfAmmoEvent: usize = 0xF26; // 
                pub const m_numRemoveUnownedWeaponThink: usize = 0xF28; // 
                pub const m_IronSightController: usize = 0xF30; // 
                pub const m_iIronSightMode: usize = 0xF48; // 
                pub const m_flLastLOSTraceFailureTime: usize = 0xF4C; // 
                pub const m_iNumEmptyAttacks: usize = 0xF50; // 
                pub const m_flWatTickOffset: usize = 0xF54; // 
            }
            // Parent: CBaseEntity
            // Field count: 0
            ...
            pub mod CTriggerImpact {
                pub const m_flMagnitude: usize = 0x988; // 
                pub const m_flNoise: usize = 0x98C; // 
                pub const m_flViewkick: usize = 0x990; // 
            ...
            pub mod CSun {
                pub const m_vDirection: usize = 0x790; // 
                pub const m_clrOverlay: usize = 0x79C; // 
                pub const m_iszEffectName: usize = 0x7A0; // 
                pub const m_iszSSEffectName: usize = 0x7A8; // 
                pub const m_bOn: usize = 0x7B0; // 
                pub const m_bmaxColor: usize = 0x7B1; // 
                pub const m_flSize: usize = 0x7B4; // 
                pub const m_flRotation: usize = 0x7B8; // 
                pub const m_flHazeScale: usize = 0x7BC; // 
                pub const m_flAlphaHaze: usize = 0x7C0; // 
                pub const m_flAlphaHdr: usize = 0x7C4; // 
                pub const m_flAlphaScale: usize = 0x7C8; // 
                pub const m_flHDRColorScale: usize = 0x7CC; // 
                pub const m_flFarZScale: usize = 0x7D0; // 
            }
            // Parent: CBaseTrigger
            // Field count: 2
            pub mod CTriggerDetectBulletFire {
                pub const m_bPlayerFireOnly: usize = 0x960; // 
                pub const m_OnDetectedBulletFire: usize = 0x968; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 0
            pub mod CWorld {
            ...
            pub mod CTriggerTeleport {
                ...
                pub const m_bUseLandmarkAngles: usize = 0x968; // 
                pub const m_bMirrorPlayer: usize = 0x969; // 
                pub const m_bCheckDestIfClearForPlayer: usize = 0x96A; // 
            }
            // Parent: CCSPlayerBase_CameraServices
            // Field count: 0
            ...
            // Field count: 38
            pub mod CFuncMover {
                pub const m_bCreateMovableNavMesh: usize = 0x790; // 
                ...
                pub const m_bIsReversing: usize = 0x7B4; // 
                pub const m_vTarget: usize = 0x7B8; // 
                pub const m_flStartSpeed: usize = 0x7C4; // 
                pub const m_flPathLocation: usize = 0x7C8; // 
                pub const m_flT: usize = 0x7CC; // 
                pub const m_nCurrentNodeIndex: usize = 0x7D0; // 
                pub const m_nPreviousNodeIndex: usize = 0x7D4; // 
                pub const m_bFixedOrientation: usize = 0x7D8; // 
                pub const m_bFixedPitch: usize = 0x7D9; // 
                pub const m_eSolidType: usize = 0x7DA; // 
                pub const m_bIsMoving: usize = 0x7DB; // 
                pub const m_flTimeToReachMaxSpeed: usize = 0x7DC; // 
                pub const m_flDistanceToReachMaxSpeed: usize = 0x7E0; // 
                pub const m_flTimeToReachZeroSpeed: usize = 0x7E4; // 
                pub const m_flDistanceToReachZeroSpeed: usize = 0x7E8; // 
                pub const m_flTimeMovementStart: usize = 0x7EC; // 
                pub const m_flTimeMovementStop: usize = 0x7F0; // 
                pub const m_hStopAtNode: usize = 0x7F4; // 
                pub const m_flPathLocationToBeginStop: usize = 0x7F8; // 
                ...
                pub const m_OnMovementEnd: usize = 0x840; // 
                pub const m_bStartAtEnd: usize = 0x868; // 
                ...
                pub const m_qOriginalOrientation: usize = 0x880; // 
            }
            // Parent: None
            // Field count: 5
            //
            ...
            // Field count: 3
            pub mod CBubbling {
                pub const m_density: usize = 0x790; // 
                pub const m_frequency: usize = 0x794; // 
                pub const m_state: usize = 0x798; // 
            }
            ...
            pub mod CColorCorrectionVolume {
                pub const m_bEnabled: usize = 0x960; // 
                pub const m_MaxWeight: usize = 0x964; // 
                pub const m_FadeDuration: usize = 0x968; // 
                pub const m_bStartDisabled: usize = 0x96C; // 
                pub const m_Weight: usize = 0x970; // 
                pub const m_lookupFilename: usize = 0x974; // 
                pub const m_LastEnterWeight: usize = 0xB74; // 
                pub const m_LastEnterTime: usize = 0xB78; // 
                pub const m_LastExitWeight: usize = 0xB7C; // 
                pub const m_LastExitTime: usize = 0xB80; // 
            }
            // Parent: CBaseFilter
            // Field count: 5
            ...
            pub mod CEnvExplosion {
                pub const m_iMagnitude: usize = 0x790; // 
                pub const m_flPlayerDamage: usize = 0x794; // 
                pub const m_iRadiusOverride: usize = 0x798; // 
                pub const m_flInnerRadius: usize = 0x79C; // 
                pub const m_spriteScale: usize = 0x7A0; // 
                pub const m_flDamageForce: usize = 0x7A4; // 
                pub const m_hInflictor: usize = 0x7A8; // 
                pub const m_iCustomDamageType: usize = 0x7AC; // 
                pub const m_bCreateDebris: usize = 0x7B0; // 
                ...
                pub const m_iClassIgnore: usize = 0x7D0; // 
                pub const m_iClassIgnore2: usize = 0x7D4; // 
            ...
            pub mod CPointCommentaryNode {
                ...
                pub const m_bPreventMovement: usize = 0x9E0; // 
                pub const m_bUnderCrosshair: usize = 0x9E1; // 
                pub const m_bUnstoppable: usize = 0x9E2; // 
                pub const m_flFinishedTime: usize = 0x9E4; // 
                pub const m_vecFinishOrigin: usize = 0x9E8; // 
                pub const m_vecOriginalAngles: usize = 0x9F4; // 
                pub const m_vecFinishAngles: usize = 0xA00; // 
                pub const m_bPreventChangesWhileMoving: usize = 0xA0C; // 
                pub const m_bDisabled: usize = 0xA0D; // 
                pub const m_vecTeleportOrigin: usize = 0xA10; // 
                pub const m_flAbortedPlaybackAt: usize = 0xA1C; // 
                pub const m_pOnCommentaryStarted: usize = 0xA20; // 
                pub const m_pOnCommentaryStopped: usize = 0xA48; // 
                pub const m_bActive: usize = 0xA70; // 
                pub const m_flStartTime: usize = 0xA74; // 
                pub const m_flStartTimeInCommentary: usize = 0xA78; // 
                pub const m_iszTitle: usize = 0xA80; // 
                pub const m_iszSpeakers: usize = 0xA88; // 
                pub const m_iNodeNumber: usize = 0xA90; // 
                pub const m_iNodeNumberMax: usize = 0xA94; // 
                pub const m_bListenedTo: usize = 0xA98; // 
            }
            ...
            pub mod CPointClientUIWorldPanel {
                pub const m_bIgnoreInput: usize = 0x940; // 
                pub const m_bLit: usize = 0x941; // 
                pub const m_bFollowPlayerAcrossTeleport: usize = 0x942; // 
                pub const m_flWidth: usize = 0x944; // 
                pub const m_flHeight: usize = 0x948; // 
                pub const m_flDPI: usize = 0x94C; // 
                pub const m_flInteractDistance: usize = 0x950; // 
                pub const m_flDepthOffset: usize = 0x954; // 
                pub const m_unOwnerContext: usize = 0x958; // 
                pub const m_unHorizontalAlign: usize = 0x95C; // 
                pub const m_unVerticalAlign: usize = 0x960; // 
                pub const m_unOrientation: usize = 0x964; // 
                pub const m_bAllowInteractionFromAllSceneWorlds: usize = 0x968; // 
                pub const m_vecCSSClasses: usize = 0x970; // CNetworkUtlVectorBase<CUtlSymbolLarge>
                pub const m_bOpaque: usize = 0x988; // 
                pub const m_bNoDepth: usize = 0x989; // 
                pub const m_bRenderBackface: usize = 0x98A; // 
                pub const m_bUseOffScreenIndicator: usize = 0x98B; // 
                pub const m_bExcludeFromSaveGames: usize = 0x98C; // 
                pub const m_bGrabbable: usize = 0x98D; // 
                pub const m_bOnlyRenderToTexture: usize = 0x98E; // 
                pub const m_bDisableMipGen: usize = 0x98F; // 
                pub const m_nExplicitImageLayout: usize = 0x990; // 
            }
            // Parent: CBaseFilter
            // Field count: 1
            ...
            pub mod CCSPlayer_ActionTrackingServices {
                ...
                pub const m_bIsRescuing: usize = 0x22C; // 
                pub const m_weaponPurchasesThisMatch: usize = 0x230; // 
                pub const m_weaponPurchasesThisRound: usize = 0x288; // 
            }
            // Parent: CPointEntity
            // Field count: 6
            pub mod CAISound {
            ...
            // Field count: 4
            pub mod CBaseProp {
                pub const m_bModelOverrodeBlockLOS: usize = 0x9A8; // 
                pub const m_iShapeType: usize = 0x9AC; // 
                pub const m_bConformToCollisionBounds: usize = 0x9B0; // 
                pub const m_mPreferredCatchTransform: usize = 0x9B4; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 12
            //
            ...
            // NetworkVarNames: m_bEnabled (bool)
            pub mod CEnvSky {
                pub const m_hSkyMaterial: usize = 0x790; // 
                pub const m_hSkyMaterialLightingOnly: usize = 0x798; // 
                pub const m_bStartDisabled: usize = 0x7A0; // 
                pub const m_vTintColor: usize = 0x7A1; // 
                pub const m_vTintColorLightingOnly: usize = 0x7A5; // 
                pub const m_flBrightnessScale: usize = 0x7AC; // 
                pub const m_nFogType: usize = 0x7B0; // 
                pub const m_flFogMinStart: usize = 0x7B4; // 
                pub const m_flFogMinEnd: usize = 0x7B8; // 
                pub const m_flFogMaxStart: usize = 0x7BC; // 
                pub const m_flFogMaxEnd: usize = 0x7C0; // 
                pub const m_bEnabled: usize = 0x7C4; // 
            }
            // Parent: CPointEntity
            // Field count: 6
            ...
            pub mod CFuncTankTrain {
                pub const m_OnDeath: usize = 0x8E0; // 
            }
            // Parent: CBaseEntity
            // Field count: 0
            pub mod CNullEntity {
            ...
            pub mod CMarkupVolumeTagged_NavGame {
                pub const m_bFloodFillAttribute: usize = 0x7E8; // 
            }
            // Parent: CBaseTrigger
            // Field count: 1
            pub mod CBuyZone {
                pub const m_LegacyTeamNum: usize = 0x960; // 
            }
            // Parent: CLogicalEntity
            // Field count: 12
            ...
            pub mod CFlashbangProjectile {
                pub const m_flTimeToDetonate: usize = 0xB50; // 
                pub const m_numOpponentsHit: usize = 0xB54; // 
                pub const m_numTeammatesHit: usize = 0xB55; // 
            }
            ...
            pub mod CBaseButton {
                ...
                pub const m_fStayPushed: usize = 0x81C; // 
                pub const m_fRotating: usize = 0x81D; // 
                pub const m_ls: usize = 0x820; // 
                ...
                pub const m_bLocked: usize = 0x860; // 
                pub const m_bDisabled: usize = 0x861; // 
                pub const m_flUseLockedTime: usize = 0x864; // 
                pub const m_bSolidBsp: usize = 0x868; // 
                pub const m_OnDamaged: usize = 0x870; // 
                pub const m_OnPressed: usize = 0x898; // 
                pub const m_OnUseLocked: usize = 0x8C0; // 
                pub const m_OnIn: usize = 0x8E8; // 
                pub const m_OnOut: usize = 0x910; // 
                pub const m_nState: usize = 0x938; // 
                pub const m_hConstraint: usize = 0x93C; // 
                pub const m_hConstraintParent: usize = 0x940; // 
                pub const m_bForceNpcExclude: usize = 0x944; // 
                pub const m_sGlowEntity: usize = 0x948; // 
                pub const m_glowEntity: usize = 0x950; // 
                pub const m_usable: usize = 0x954; // 
            ...
            pub mod CCSGOViewModel {
                pub const m_bShouldIgnoreOffsetAndAccuracy: usize = 0x9F0; // 
            }
            // Parent: CCSWeaponBaseGun
            // Field count: 3
            //
            ...
            pub mod CWeaponShield {
                pub const m_flBulletDamageAbsorbed: usize = 0xF78; // 
                pub const m_flLastBulletHitSoundTime: usize = 0xF7C; // 
                pub const m_flDisplayHealth: usize = 0xF80; // 
            }
            // Parent: CPointEntity
            // Field count: 4
            pub mod CBlood {
            ...
            pub mod CBreakableProp {
                ...
                pub const m_OnBreak: usize = 0xA30; // 
                pub const m_OnHealthChanged: usize = 0xA58; // CEntityOutputTemplate<float32>
                pub const m_OnTakeDamage: usize = 0xA80; // 
                pub const m_impactEnergyScale: usize = 0xAA8; // 
                pub const m_iMinHealthDmg: usize = 0xAAC; // 
                pub const m_preferredCarryAngles: usize = 0xAB0; // 
                pub const m_flPressureDelay: usize = 0xABC; // 
                pub const m_flDefBurstScale: usize = 0xAC0; // 
                pub const m_vDefBurstOffset: usize = 0xAC4; // 
                pub const m_hBreaker: usize = 0xAD0; // 
                pub const m_PerformanceMode: usize = 0xAD4; // 
                pub const m_flPreventDamageBeforeTime: usize = 0xAD8; // 
                pub const m_BreakableContentsType: usize = 0xADC; // 
                pub const m_strBreakableContentsPropGroupOverride: usize = 0xAE0; // 
                pub const m_strBreakableContentsParticleOverride: usize = 0xAE8; // 
                pub const m_bHasBreakPiecesOrCommands: usize = 0xAF0; // 
                pub const m_explodeDamage: usize = 0xAF4; // 
                pub const m_explodeRadius: usize = 0xAF8; // 
                pub const m_explosionDelay: usize = 0xB00; // 
                ...
                pub const m_flLastPhysicsInfluenceTime: usize = 0xB2C; // 
                pub const m_bOriginalBlockLOS: usize = 0xB30; // 
                pub const m_flDefaultFadeScale: usize = 0xB34; // 
                pub const m_hLastAttacker: usize = 0xB38; // 
                pub const m_hFlareEnt: usize = 0xB3C; // 
                pub const m_bUsePuntSound: usize = 0xB40; // 
                pub const m_iszPuntSound: usize = 0xB48; // 
                pub const m_noGhostCollision: usize = 0xB50; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 1
            //
            ...
            pub mod CBaseCombatCharacter {
                pub const m_bForceServerRagdoll: usize = 0xA38; // 
                pub const m_hMyWearables: usize = 0xA40; // CNetworkUtlVectorBase<CHandle<CEconWearable>>
                pub const m_impactEnergyScale: usize = 0xA58; // 
                pub const m_bApplyStressDamage: usize = 0xA5C; // 
                pub const m_iDamageCount: usize = 0xAA0; // 
                ...
                pub const m_nNavHullIdx: usize = 0xABC; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 25
            //
            ...
            pub mod CInferno {
                ...
                pub const m_fireCount: usize = 0x10E0; // 
                pub const m_nInfernoType: usize = 0x10E4; // 
                pub const m_nFireEffectTickBegin: usize = 0x10E8; // 
                pub const m_nFireLifetime: usize = 0x10EC; // 
                pub const m_bInPostEffectTime: usize = 0x10F0; // 
                pub const m_nFiresExtinguishCount: usize = 0x10F4; // 
                pub const m_bWasCreatedInSmoke: usize = 0x10F8; // 
                pub const m_extent: usize = 0x1300; // 
                pub const m_damageTimer: usize = 0x1318; // 
                pub const m_damageRampTimer: usize = 0x1330; // 
                pub const m_splashVelocity: usize = 0x1348; // 
                pub const m_InitialSplashVelocity: usize = 0x1354; // 
                pub const m_startPos: usize = 0x1360; // 
                pub const m_vecOriginalSpawnLocation: usize = 0x136C; // 
                pub const m_activeTimer: usize = 0x1378; // 
                pub const m_fireSpawnOffset: usize = 0x1388; // 
                pub const m_nMaxFlames: usize = 0x138C; // 
                pub const m_nSpreadCount: usize = 0x1390; // 
                pub const m_BookkeepingTimer: usize = 0x1398; // 
                pub const m_NextSpreadTimer: usize = 0x13B0; // 
                pub const m_nSourceItemDefIndex: usize = 0x13C8; // 
            }
            // Parent: CLogicalEntity
            // Field count: 5
            pub mod CEnvGlobal {
            ...
            // NetworkVarNames: m_flHDRColorScale (float32)
            pub mod CSprite {
                pub const m_hSpriteMaterial: usize = 0x790; // 
                pub const m_hAttachedToEntity: usize = 0x798; // 
                pub const m_nAttachment: usize = 0x79C; // 
                pub const m_flSpriteFramerate: usize = 0x7A0; // 
                pub const m_flFrame: usize = 0x7A4; // 
                pub const m_flDieTime: usize = 0x7A8; // 
                pub const m_nBrightness: usize = 0x7B8; // 
                pub const m_flBrightnessDuration: usize = 0x7BC; // 
                pub const m_flSpriteScale: usize = 0x7C0; // 
                pub const m_flScaleDuration: usize = 0x7C4; // 
                pub const m_bWorldSpaceScale: usize = 0x7C8; // 
                pub const m_flGlowProxySize: usize = 0x7CC; // 
                pub const m_flHDRColorScale: usize = 0x7D0; // 
                pub const m_flLastTime: usize = 0x7D4; // 
                pub const m_flMaxFrame: usize = 0x7D8; // 
                pub const m_flStartScale: usize = 0x7DC; // 
                pub const m_flDestScale: usize = 0x7E0; // 
                pub const m_flScaleTimeStart: usize = 0x7E4; // 
                pub const m_nStartBrightness: usize = 0x7E8; // 
                pub const m_nDestBrightness: usize = 0x7EC; // 
                pub const m_flBrightnessTimeStart: usize = 0x7F0; // 
                pub const m_nSpriteWidth: usize = 0x7F4; // 
                pub const m_nSpriteHeight: usize = 0x7F8; // 
            }
            // Parent: CBaseTrigger
            // Field count: 0
            ...
            pub mod CChicken {
                ...
                pub const m_flWhenZombified: usize = 0x1018; // 
                pub const m_jumpedThisFrame: usize = 0x101C; // 
                pub const m_leader: usize = 0x1020; // 
                pub const m_reuseTimer: usize = 0x1038; // 
                pub const m_hasBeenUsed: usize = 0x1050; // 
                pub const m_jumpTimer: usize = 0x1058; // 
                pub const m_flLastJumpTime: usize = 0x1070; // 
                pub const m_bInJump: usize = 0x1074; // 
                pub const m_repathTimer: usize = 0x3080; // 
                pub const m_vecPathGoal: usize = 0x3118; // 
                pub const m_flActiveFollowStartTime: usize = 0x3124; // 
            ...
            pub mod CChangeLevel {
                pub const m_sMapName: usize = 0x960; // 
                pub const m_sLandmarkName: usize = 0x968; // 
                pub const m_OnChangeLevel: usize = 0x970; // 
                pub const m_bTouched: usize = 0x998; // 
                pub const m_bNoTouch: usize = 0x999; // 
                pub const m_bNewChapter: usize = 0x99A; // 
                pub const m_bOnChangeLevelFired: usize = 0x99B; // 
            }
            // Parent: CBaseTrigger
            // Field count: 14
            pub mod CTriggerLerpObject {
                ...
                pub const m_flLerpDuration: usize = 0x97C; // 
                pub const m_bLerpRestoreMoveType: usize = 0x980; // 
                pub const m_bSingleLerpObject: usize = 0x981; // 
                pub const m_vecLerpingObjects: usize = 0x988; // 
                pub const m_iszLerpEffect: usize = 0x9A0; // 
                pub const m_iszLerpSound: usize = 0x9A8; // 
                pub const m_bAttachTouchingObject: usize = 0x9B0; // 
                pub const m_hEntityToWaitForDisconnect: usize = 0x9B4; // 
                pub const m_OnLerpStarted: usize = 0x9B8; // 
                pub const m_OnLerpFinished: usize = 0x9E0; // 
            }
            // Parent: CBaseToggle
            // Field count: 12
            //
            ...
            pub mod CBaseTrigger {
                pub const m_bDisabled: usize = 0x810; // 
                pub const m_iFilterName: usize = 0x818; // 
                pub const m_hFilter: usize = 0x820; // 
                pub const m_OnStartTouch: usize = 0x828; // 
                pub const m_OnStartTouchAll: usize = 0x850; // 
                pub const m_OnEndTouch: usize = 0x878; // 
                pub const m_OnEndTouchAll: usize = 0x8A0; // 
                pub const m_OnTouching: usize = 0x8C8; // 
                pub const m_OnTouchingEachEntity: usize = 0x8F0; // 
                pub const m_OnNotTouching: usize = 0x918; // 
                pub const m_hTouchingEntities: usize = 0x940; // CUtlVector<CHandle<CBaseEntity>>
                pub const m_bClientSidePredicted: usize = 0x958; // 
            }
            // Parent: CPointEntity
            // Field count: 0
            ...
            pub mod CEconEntity {
                ...
                pub const m_OriginalOwnerXuidLow: usize = 0xD10; // 
                pub const m_OriginalOwnerXuidHigh: usize = 0xD14; // 
                pub const m_nFallbackPaintKit: usize = 0xD18; // 
                pub const m_nFallbackSeed: usize = 0xD1C; // 
                pub const m_flFallbackWear: usize = 0xD20; // 
                pub const m_nFallbackStatTrak: usize = 0xD24; // 
                pub const m_hOldProvidee: usize = 0xD28; // 
                pub const m_iOldOwnerClass: usize = 0xD2C; // 
            }
            // Parent: None
            // Field count: 17
            //
            ...
            pub mod CPointWorldText {
                ...
                pub const m_FontName: usize = 0x990; // 
                pub const m_bEnabled: usize = 0x9D0; // 
                pub const m_bFullbright: usize = 0x9D1; // 
                pub const m_flWorldUnitsPerPx: usize = 0x9D4; // 
                pub const m_flFontSize: usize = 0x9D8; // 
                pub const m_flDepthOffset: usize = 0x9DC; // 
                pub const m_Color: usize = 0x9E0; // 
                pub const m_nJustifyHorizontal: usize = 0x9E4; // 
                pub const m_nJustifyVertical: usize = 0x9E8; // 
                pub const m_nReorientMode: usize = 0x9EC; // 
            }
            // Parent: CSoundAreaEntityBase
            // Field count: 2
            //
            ...
            pub mod CTriggerPhysics {
                pub const m_gravityScale: usize = 0x970; // 
                pub const m_linearLimit: usize = 0x974; // 
                pub const m_linearDamping: usize = 0x978; // 
                pub const m_angularLimit: usize = 0x97C; // 
                pub const m_angularDamping: usize = 0x980; // 
                pub const m_linearForce: usize = 0x984; // 
                pub const m_flFrequency: usize = 0x988; // 
                pub const m_flDampingRatio: usize = 0x98C; // 
                pub const m_vecLinearForcePointAt: usize = 0x990; // 
                pub const m_bCollapseToForcePoint: usize = 0x99C; // 
                pub const m_vecLinearForcePointAtWorld: usize = 0x9A0; // 
                pub const m_vecLinearForceDirection: usize = 0x9AC; // 
                pub const m_bConvertToDebrisWhenPossible: usize = 0x9B8; // 
            }
            // Parent: None
            // Field count: 2
            //
            ...
            pub mod CFuncShatterglass {
                pub const m_matPanelTransform: usize = 0x790; // 
                pub const m_matPanelTransformWsTemp: usize = 0x7C0; // 
                pub const m_vecShatterGlassShards: usize = 0x7F0; // 
                pub const m_PanelSize: usize = 0x808; // 
                pub const m_flLastShatterSoundEmitTime: usize = 0x810; // 
                pub const m_flLastCleanupTime: usize = 0x814; // 
                pub const m_flInitAtTime: usize = 0x818; // 
                pub const m_flGlassThickness: usize = 0x81C; // 
                pub const m_flSpawnInvulnerability: usize = 0x820; // 
                pub const m_bBreakSilent: usize = 0x824; // 
                pub const m_bBreakShardless: usize = 0x825; // 
                pub const m_bBroken: usize = 0x826; // 
                pub const m_bGlassNavIgnore: usize = 0x827; // 
                pub const m_bGlassInFrame: usize = 0x828; // 
                pub const m_bStartBroken: usize = 0x829; // 
                pub const m_iInitialDamageType: usize = 0x82A; // 
                ...
                pub const m_OnBroken: usize = 0x898; // 
                pub const m_iSurfaceType: usize = 0x8C0; // 
                pub const m_hMaterialDamageBase: usize = 0x8C8; // 
            }
            // Parent: CBaseButton
            // Field count: 0
            pub mod CRotButton {
            ...
            // NetworkVarNames: m_hControlPanel (CHandle<CBaseEntity>)
            pub mod CPlantedC4 {
                pub const m_bBombTicking: usize = 0x9B0; // 
                pub const m_flC4Blow: usize = 0x9B4; // 
                pub const m_nBombSite: usize = 0x9B8; // 
                pub const m_nSourceSoundscapeHash: usize = 0x9BC; // 
                pub const m_AttributeManager: usize = 0x9C0; // 
                pub const m_OnBombDefused: usize = 0xC88; // 
                pub const m_OnBombBeginDefuse: usize = 0xCB0; // 
                pub const m_OnBombDefuseAborted: usize = 0xCD8; // 
                pub const m_bCannotBeDefused: usize = 0xD00; // 
                pub const m_entitySpottedState: usize = 0xD08; // 
                pub const m_nSpotRules: usize = 0xD20; // 
                pub const m_bTrainingPlacedByPlayer: usize = 0xD24; // 
                pub const m_bHasExploded: usize = 0xD25; // 
                pub const m_flTimerLength: usize = 0xD28; // 
                pub const m_bBeingDefused: usize = 0xD2C; // 
                pub const m_fLastDefuseTime: usize = 0xD34; // 
                pub const m_flDefuseLength: usize = 0xD3C; // 
                pub const m_flDefuseCountDown: usize = 0xD40; // 
                pub const m_bBombDefused: usize = 0xD44; // 
                pub const m_hBombDefuser: usize = 0xD48; // 
                pub const m_hControlPanel: usize = 0xD4C; // 
                pub const m_iProgressBarTime: usize = 0xD50; // 
                pub const m_bVoiceAlertFired: usize = 0xD54; // 
                pub const m_bVoiceAlertPlayed: usize = 0xD55; // 
                pub const m_flNextBotBeepTime: usize = 0xD5C; // 
                pub const m_angCatchUpToPlayerEye: usize = 0xD64; // 
                pub const m_flLastSpinDetectionTime: usize = 0xD70; // 
            }
            // Parent: CBaseClientUIEntity
            // Field count: 2
            //
            ...
            pub mod CPointClientUIDialog {
                ...
                pub const m_bStartEnabled: usize = 0x944; // 
            }
            // Parent: CPointEntity
            // Field count: 1
            pub mod CEnvSplash {
            ...
            pub mod CWeaponTaser {
                pub const m_fFireTime: usize = 0xF78; // 
                pub const m_nLastAttackTick: usize = 0xF7C; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 0
            ...
            pub mod CBreakable {
                ...
                pub const m_Material: usize = 0x7D8; // 
                pub const m_hBreaker: usize = 0x7DC; // 
                pub const m_Explosion: usize = 0x7E0; // 
                pub const m_iszSpawnObject: usize = 0x7E8; // 
                pub const m_flPressureDelay: usize = 0x7F0; // 
                pub const m_iMinHealthDmg: usize = 0x7F4; // 
                pub const m_iszPropData: usize = 0x7F8; // 
                pub const m_impactEnergyScale: usize = 0x800; // 
                pub const m_nOverrideBlockLOS: usize = 0x804; // 
                pub const m_OnBreak: usize = 0x808; // 
                pub const m_OnHealthChanged: usize = 0x830; // CEntityOutputTemplate<float32>
                pub const m_PerformanceMode: usize = 0x858; // 
                pub const m_hPhysicsAttacker: usize = 0x85C; // 
                pub const m_flLastPhysicsInfluenceTime: usize = 0x860; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 16
            pub mod CBaseToggle {
                pub const m_toggle_state: usize = 0x790; // 
                pub const m_flMoveDistance: usize = 0x794; // 
                pub const m_flWait: usize = 0x798; // 
                pub const m_flLip: usize = 0x79C; // 
                pub const m_bAlwaysFireBlockedOutputs: usize = 0x7A0; // 
                pub const m_vecPosition1: usize = 0x7A4; // 
                pub const m_vecPosition2: usize = 0x7B0; // 
                pub const m_vecMoveAng: usize = 0x7BC; // 
                pub const m_vecAngle1: usize = 0x7C8; // 
                pub const m_vecAngle2: usize = 0x7D4; // 
                pub const m_flHeight: usize = 0x7E0; // 
                pub const m_hActivator: usize = 0x7E4; // 
                pub const m_vecFinalDest: usize = 0x7E8; // 
                pub const m_vecFinalAngle: usize = 0x7F4; // 
                pub const m_movementType: usize = 0x800; // 
            ...
            pub mod CMomentaryRotButton {
                ...
                pub const m_OnUnpressed: usize = 0x988; // 
                pub const m_OnFullyOpen: usize = 0x9B0; // 
                pub const m_OnFullyClosed: usize = 0x9D8; // 
                pub const m_OnReachedPosition: usize = 0xA00; // 
                pub const m_lastUsed: usize = 0xA28; // 
                pub const m_start: usize = 0xA2C; // 
                pub const m_end: usize = 0xA38; // 
                pub const m_IdealYaw: usize = 0xA44; // 
                pub const m_sNoise: usize = 0xA48; // 
                pub const m_bUpdateTarget: usize = 0xA50; // 
                pub const m_direction: usize = 0xA54; // 
                pub const m_returnSpeed: usize = 0xA58; // 
                pub const m_flStartPosition: usize = 0xA5C; // 
            }
            // Parent: CEntityComponent
            // Field count: 10
            ...
            pub mod CGameText {
                ...
                pub const m_textParms: usize = 0x7A8; // 
            }
            // Parent: CCSWeaponBaseGun
            // Field count: 0
            ...
            pub mod CTextureBasedAnimatable {
                pub const m_bLoop: usize = 0x790; // 
                pub const m_flFPS: usize = 0x794; // 
                pub const m_hPositionKeys: usize = 0x798; // 
                pub const m_hRotationKeys: usize = 0x7A0; // 
                pub const m_vAnimationBoundsMin: usize = 0x7A8; // 
                pub const m_vAnimationBoundsMax: usize = 0x7B4; // 
                pub const m_flStartTime: usize = 0x7C0; // 
                pub const m_flStartFrame: usize = 0x7C4; // 
            }
            // Parent: CMarkupVolumeTagged
            // Field count: 3
            pub mod CMarkupVolumeWithRef {
                pub const m_bUseRef: usize = 0x7D0; // 
                pub const m_vRefPos: usize = 0x7D4; // 
                pub const m_flRefDot: usize = 0x7E0; // 
            }
            // Parent: CPhysForce
            // Field count: 1
            ...
            pub mod CShatterGlassShardPhysics {
                pub const m_bDebris: usize = 0xD00; // 
                pub const m_hParentShard: usize = 0xD04; // 
                pub const m_ShardDesc: usize = 0xD08; // 
            }
            // Parent: CBaseFilter
            // Field count: 1
            ...
            pub mod CCSPlayerPawnBase {
                ...
                pub const m_pPingServices: usize = 0xCB8; // 
                pub const m_pViewModelServices: usize = 0xCC0; // 
                pub const m_blindUntilTime: usize = 0xCC8; // 
                pub const m_blindStartTime: usize = 0xCCC; // 
                pub const m_iPlayerState: usize = 0xCD0; // 
                pub const m_bRespawning: usize = 0xD80; // 
                pub const m_fImmuneToGunGameDamageTime: usize = 0xD84; // 
                pub const m_bGunGameImmunity: usize = 0xD88; // 
                pub const m_fMolotovDamageTime: usize = 0xD8C; // 
                pub const m_bHasMovedSinceSpawn: usize = 0xD90; // 
                pub const m_iNumSpawns: usize = 0xD94; // 
                pub const m_flIdleTimeSinceLastAction: usize = 0xD9C; // 
                pub const m_fNextRadarUpdateTime: usize = 0xDA0; // 
                pub const m_flFlashDuration: usize = 0xDA4; // 
                pub const m_flFlashMaxAlpha: usize = 0xDA8; // 
                pub const m_flProgressBarStartTime: usize = 0xDAC; // 
                pub const m_iProgressBarDuration: usize = 0xDB0; // 
                pub const m_angEyeAngles: usize = 0xDB4; // 
                pub const m_wasNotKilledNaturally: usize = 0xDC0; // 
                pub const m_bCommittingSuicideOnTeamChange: usize = 0xDC1; // 
            ...
            pub mod COmniLight {
                pub const m_flInnerAngle: usize = 0xAB0; // 
                pub const m_flOuterAngle: usize = 0xAB4; // 
                pub const m_bShowLight: usize = 0xAB8; // 
            }
            // Parent: CPointEntity
            // Field count: 10
            //
            ...
            pub mod CCSWeaponBaseGun {
                pub const m_zoomLevel: usize = 0xF58; // 
                pub const m_iBurstShotsRemaining: usize = 0xF5C; // 
                pub const m_silencedModelIndex: usize = 0xF68; // 
                pub const m_inPrecache: usize = 0xF6C; // 
                pub const m_bNeedsBoltAction: usize = 0xF6D; // 
                pub const m_bSkillReloadAvailable: usize = 0xF6E; // 
                pub const m_bSkillReloadLiftedReloadKey: usize = 0xF6F; // 
                pub const m_bSkillBoltInterruptAvailable: usize = 0xF70; // 
                pub const m_bSkillBoltLiftedFireKey: usize = 0xF71; // 
            }
            // Parent: None
            // Field count: 13
            pub mod CBot {
            ...
            // Field count: 3
            pub mod CGunTarget {
                pub const m_on: usize = 0x810; // 
                pub const m_hTargetEnt: usize = 0x814; // 
                pub const m_OnDeath: usize = 0x818; // 
            }
            // Parent: CBaseEntity
            // Field count: 2
            ...
            pub mod CMarkupVolumeTagged {
                pub const m_bIsGroup: usize = 0x7C8; // 
                pub const m_bGroupByPrefab: usize = 0x7C9; // 
                pub const m_bGroupByVolume: usize = 0x7CA; // 
                pub const m_bGroupOtherGroups: usize = 0x7CB; // 
                pub const m_bIsInGroup: usize = 0x7CC; // 
            }
            // Parent: CBaseEntity
            // Field count: 5
            pub mod CTestEffect {
            ...
            pub mod CScriptNavBlocker {
                pub const m_vExtent: usize = 0x7A0; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 1
            pub mod CConstraintAnchor {
                pub const m_massScale: usize = 0x9A8; // 
            }
            // Parent: CCSWeaponBaseGun
            // Field count: 0
            pub mod CWeaponTec9 {
            ...
            pub mod CBaseFlex {
                ...
                pub const m_vLookTargetPosition: usize = 0x9C0; // 
                pub const m_blinktoggle: usize = 0x9CC; // 
                pub const m_flAllowResponsesEndTime: usize = 0xA20; // 
                pub const m_flLastFlexAnimationTime: usize = 0xA24; // 
                pub const m_nNextSceneEventId: usize = 0xA28; // 
                pub const m_bUpdateLayerPriorities: usize = 0xA2C; // 
            }
            // Parent: CTriggerHurt
            // Field count: 1
            pub mod CScriptTriggerHurt {
                pub const m_vExtent: usize = 0xA00; // 
            }
            ...
            pub mod CCSPlayerPawn {
                ...
                pub const m_nCharacterDefIndex: usize = 0xE00; // 
                pub const m_bHasFemaleVoice: usize = 0xE02; // 
                pub const m_strVOPrefix: usize = 0xE08; // 
                pub const m_szLastPlaceName: usize = 0xE10; // 
                pub const m_bInHostageResetZone: usize = 0xED0; // 
                pub const m_bInBuyZone: usize = 0xED1; // 
                pub const m_TouchingBuyZones: usize = 0xED8; // CUtlVector<CHandle<CBaseEntity>>
                pub const m_bWasInBuyZone: usize = 0xEF0; // 
                pub const m_bInHostageRescueZone: usize = 0xEF1; // 
                pub const m_bInBombZone: usize = 0xEF2; // 
                pub const m_bWasInHostageRescueZone: usize = 0xEF3; // 
                pub const m_iRetakesOffering: usize = 0xEF4; // 
                pub const m_iRetakesOfferingCard: usize = 0xEF8; // 
                pub const m_bRetakesHasDefuseKit: usize = 0xEFC; // 
                pub const m_bRetakesMVPLastRound: usize = 0xEFD; // 
                pub const m_iRetakesMVPBoostItem: usize = 0xF00; // 
                pub const m_RetakesMVPBoostExtraUtility: usize = 0xF04; // 
                pub const m_flHealthShotBoostExpirationTime: usize = 0xF08; // 
                pub const m_flLandingTimeSeconds: usize = 0xF0C; // 
                pub const m_aimPunchAngle: usize = 0xF10; // 
                pub const m_aimPunchAngleVel: usize = 0xF1C; // 
                pub const m_aimPunchTickBase: usize = 0xF28; // 
                pub const m_aimPunchTickFraction: usize = 0xF2C; // 
                pub const m_aimPunchCache: usize = 0xF30; // 
                pub const m_bIsBuyMenuOpen: usize = 0xF48; // 
                pub const m_xLastHeadBoneTransform: usize = 0x1600; // 
                pub const m_bLastHeadBoneTransformIsValid: usize = 0x1620; // 
                pub const m_lastLandTime: usize = 0x1624; // 
                pub const m_bOnGroundLastTick: usize = 0x1628; // 
                pub const m_iPlayerLocked: usize = 0x162C; // 
                pub const m_flTimeOfLastInjury: usize = 0x1634; // 
                pub const m_flNextSprayDecalTime: usize = 0x1638; // 
                pub const m_bNextSprayDecalTimeExpedited: usize = 0x163C; // 
                pub const m_nRagdollDamageBone: usize = 0x1640; // 
                pub const m_vRagdollDamageForce: usize = 0x1644; // 
                pub const m_vRagdollDamagePosition: usize = 0x1650; // 
                pub const m_szRagdollDamageWeaponName: usize = 0x165C; // 
                pub const m_bRagdollDamageHeadshot: usize = 0x169C; // 
                pub const m_vRagdollServerOrigin: usize = 0x16A0; // 
                pub const m_EconGloves: usize = 0x16B0; // 
                pub const m_nEconGlovesChanged: usize = 0x1928; // 
                pub const m_qDeathEyeAngles: usize = 0x192C; // 
                pub const m_bSkipOneHeadConstraintUpdate: usize = 0x1938; // 
                pub const m_bLeftHanded: usize = 0x1939; // 
                pub const m_fSwitchedHandednessTime: usize = 0x193C; // 
                pub const m_flViewmodelOffsetX: usize = 0x1940; // 
                pub const m_flViewmodelOffsetY: usize = 0x1944; // 
                pub const m_flViewmodelOffsetZ: usize = 0x1948; // 
                pub const m_flViewmodelFOV: usize = 0x194C; // 
                pub const m_bIsWalking: usize = 0x1950; // 
                pub const m_fLastGivenDefuserTime: usize = 0x1954; // 
                pub const m_fLastGivenBombTime: usize = 0x1958; // 
                pub const m_flDealtDamageToEnemyMostRecentTimestamp: usize = 0x195C; // 
                pub const m_iDisplayHistoryBits: usize = 0x1960; // 
                pub const m_flLastAttackedTeammate: usize = 0x1964; // 
                pub const m_allowAutoFollowTime: usize = 0x1968; // 
                pub const m_bResetArmorNextSpawn: usize = 0x196C; // 
                pub const m_nLastKillerIndex: usize = 0x1970; // 
                pub const m_entitySpottedState: usize = 0x1978; // 
                pub const m_nSpotRules: usize = 0x1990; // 
                pub const m_bIsScoped: usize = 0x1994; // 
                pub const m_bResumeZoom: usize = 0x1995; // 
                pub const m_bIsDefusing: usize = 0x1996; // 
                pub const m_bIsGrabbingHostage: usize = 0x1997; // 
                pub const m_iBlockingUseActionInProgress: usize = 0x1998; // 
                pub const m_flEmitSoundTime: usize = 0x199C; // 
                pub const m_bInNoDefuseArea: usize = 0x19A0; // 
                pub const m_iBombSiteIndex: usize = 0x19A4; // 
                pub const m_nWhichBombZone: usize = 0x19A8; // 
                pub const m_bInBombZoneTrigger: usize = 0x19AC; // 
                pub const m_bWasInBombZoneTrigger: usize = 0x19AD; // 
                pub const m_iShotsFired: usize = 0x19B0; // 
                pub const m_flFlinchStack: usize = 0x19B4; // 
                pub const m_flVelocityModifier: usize = 0x19B8; // 
                pub const m_flHitHeading: usize = 0x19BC; // 
                pub const m_nHitBodyPart: usize = 0x19C0; // 
                pub const m_vecTotalBulletForce: usize = 0x19C4; // 
                pub const m_bWaitForNoAttack: usize = 0x19D0; // 
                pub const m_ignoreLadderJumpTime: usize = 0x19D4; // 
                pub const m_bKilledByHeadshot: usize = 0x19D8; // 
                pub const m_LastHitBox: usize = 0x19DC; // 
                pub const m_LastHealth: usize = 0x19E0; // 
                pub const m_pBot: usize = 0x19E8; // 
                pub const m_bBotAllowActive: usize = 0x19F0; // 
                pub const m_thirdPersonHeading: usize = 0x19F4; // 
                pub const m_flSlopeDropOffset: usize = 0x1A00; // 
                pub const m_flSlopeDropHeight: usize = 0x1A04; // 
                pub const m_vHeadConstraintOffset: usize = 0x1A08; // 
                pub const m_nLastPickupPriority: usize = 0x1A14; // 
                pub const m_flLastPickupPriorityTime: usize = 0x1A18; // 
                pub const m_ArmorValue: usize = 0x1A1C; // 
                pub const m_unCurrentEquipmentValue: usize = 0x1A20; // 
                pub const m_unRoundStartEquipmentValue: usize = 0x1A22; // 
                pub const m_unFreezetimeEndEquipmentValue: usize = 0x1A24; // 
                pub const m_iLastWeaponFireUsercmd: usize = 0x1A28; // 
                pub const m_bIsSpawning: usize = 0x1A2C; // 
                pub const m_iDeathFlags: usize = 0x1A38; // 
                pub const m_bHasDeathInfo: usize = 0x1A3C; // 
                pub const m_flDeathInfoTime: usize = 0x1A40; // 
                pub const m_vecDeathInfoOrigin: usize = 0x1A44; // 
                pub const m_vecPlayerPatchEconIndices: usize = 0x1A50; // 
                pub const m_GunGameImmunityColor: usize = 0x1A64; // 
                pub const m_grenadeParameterStashTime: usize = 0x1A68; // 
                pub const m_bGrenadeParametersStashed: usize = 0x1A6C; // 
                pub const m_angStashedShootAngles: usize = 0x1A70; // 
                pub const m_vecStashedGrenadeThrowPosition: usize = 0x1A7C; // 
                pub const m_vecStashedVelocity: usize = 0x1A88; // 
                pub const m_angShootAngleHistory: usize = 0x1A94; // 
                pub const m_vecThrowPositionHistory: usize = 0x1AAC; // 
                pub const m_vecVelocityHistory: usize = 0x1AC4; // 
                pub const m_PredictedDamageTags: usize = 0x1AE0; // 
                pub const m_nHighestAppliedDamageTagTick: usize = 0x1B30; // 
            }
            // Parent: CBaseGrenade
            // Field count: 0
            ...
            pub mod CBasePlayerPawn {
                ...
                pub const m_pObserverServices: usize = 0xAD8; // 
                pub const m_pWaterServices: usize = 0xAE0; // 
                pub const m_pUseServices: usize = 0xAE8; // 
                pub const m_pFlashlightServices: usize = 0xAF0; // 
                pub const m_pCameraServices: usize = 0xAF8; // 
                pub const m_pMovementServices: usize = 0xB00; // 
                pub const m_ServerViewAngleChanges: usize = 0xB10; // 
                pub const m_nHighestGeneratedServerViewAngleChangeIndex: usize = 0xB60; // 
                pub const v_angle: usize = 0xB64; // 
                pub const v_anglePrevious: usize = 0xB70; // 
                pub const m_iHideHUD: usize = 0xB7C; // 
                pub const m_skybox3d: usize = 0xB80; // 
                pub const m_fTimeLastHurt: usize = 0xC10; // 
                pub const m_flDeathTime: usize = 0xC14; // 
                pub const m_fNextSuicideTime: usize = 0xC18; // 
                pub const m_fInitHUD: usize = 0xC1C; // 
                pub const m_pExpresser: usize = 0xC20; // 
                pub const m_hController: usize = 0xC28; // CHandle<CBasePlayerController>
                pub const m_fHltvReplayDelay: usize = 0xC30; // 
                pub const m_fHltvReplayEnd: usize = 0xC34; // 
            ...
            pub mod CPostProcessingVolume {
                pub const m_hPostSettings: usize = 0x970; // 
                pub const m_flFadeDuration: usize = 0x978; // 
                pub const m_flMinLogExposure: usize = 0x97C; // 
                pub const m_flMaxLogExposure: usize = 0x980; // 
                pub const m_flMinExposure: usize = 0x984; // 
                pub const m_flMaxExposure: usize = 0x988; // 
                pub const m_flExposureCompensation: usize = 0x98C; // 
                pub const m_flExposureFadeSpeedUp: usize = 0x990; // 
                pub const m_flExposureFadeSpeedDown: usize = 0x994; // 
                pub const m_flTonemapEVSmoothingRange: usize = 0x998; // 
                pub const m_bMaster: usize = 0x99C; // 
                pub const m_bExposureControl: usize = 0x99D; // 
                pub const m_flRate: usize = 0x9A0; // 
                pub const m_flTonemapPercentTarget: usize = 0x9A4; // 
                pub const m_flTonemapPercentBrightPixels: usize = 0x9A8; // 
                pub const m_flTonemapMinAvgLum: usize = 0x9AC; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 4
            //
            ...
            pub mod CSpotlightEnd {
                pub const m_flLightScale: usize = 0x790; // 
                pub const m_Radius: usize = 0x794; // 
                pub const m_vSpotlightDir: usize = 0x798; // 
                pub const m_vSpotlightOrg: usize = 0x7A4; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 1
            pub mod CRuleEntity {
            ...
            pub mod CTriggerDetectExplosion {
                pub const m_OnDetectedExplosion: usize = 0x988; // 
            }
            // Parent: CLogicalEntity
            // Field count: 1
            ...
            pub mod CEconWearable {
                pub const m_nForceSkin: usize = 0xD30; // 
                pub const m_bAlwaysAllow: usize = 0xD34; // 
            }
            // Parent: CPlayerPawnComponent
            // Field count: 0
            ...
            pub mod CFuncConveyor {
                ...
                pub const m_flTransitionDurationSeconds: usize = 0x798; // 
                pub const m_angMoveEntitySpace: usize = 0x79C; // 
                pub const m_vecMoveDirEntitySpace: usize = 0x7A8; // 
                pub const m_flTargetSpeed: usize = 0x7B4; // 
                pub const m_nTransitionStartTick: usize = 0x7B8; // 
                pub const m_nTransitionDurationTicks: usize = 0x7BC; // 
                pub const m_flTransitionStartSpeed: usize = 0x7C0; // 
            ...
            // NetworkVarNames: m_bShowLight (bool)
            pub mod CRectLight {
                pub const m_bShowLight: usize = 0xAB0; // 
            }
            // Parent: CCSGO_TeamSelectCharacterPosition
            // Field count: 0
            ...
            // Field count: 1
            pub mod CRotDoor {
                pub const m_bSolidBsp: usize = 0xA18; // 
            }
            // Parent: CLogicalEntity
            // Field count: 4
            ...
            // NetworkVarNames: m_entitySpottedState (EntitySpottedState_t)
            pub mod CC4 {
                pub const m_vecLastValidPlayerHeldPosition: usize = 0xF88; // 
                pub const m_vecLastValidDroppedPosition: usize = 0xF94; // 
                pub const m_bDoValidDroppedPositionCheck: usize = 0xFA0; // 
                pub const m_bStartedArming: usize = 0xFA1; // 
                pub const m_fArmedTime: usize = 0xFA4; // 
                pub const m_bBombPlacedAnimation: usize = 0xFA8; // 
                pub const m_bIsPlantingViaUse: usize = 0xFA9; // 
                pub const m_entitySpottedState: usize = 0xFB0; // 
                pub const m_nSpotRules: usize = 0xFC8; // 
                pub const m_bPlayedArmingBeeps: usize = 0xFCC; // 
                pub const m_bBombPlanted: usize = 0xFD3; // 
            }
            ...
            pub mod CBaseDoor {
                pub const m_angMoveEntitySpace: usize = 0x820; // 
                pub const m_vecMoveDirParentSpace: usize = 0x82C; // 
                pub const m_ls: usize = 0x838; // 
                pub const m_bForceClosed: usize = 0x858; // 
                pub const m_bDoorGroup: usize = 0x859; // 
                pub const m_bLocked: usize = 0x85A; // 
                pub const m_bIgnoreDebris: usize = 0x85B; // 
                pub const m_eSpawnPosition: usize = 0x85C; // 
                pub const m_flBlockDamage: usize = 0x860; // 
                ...
                pub const m_OnBlockedClosing: usize = 0x890; // 
                pub const m_OnBlockedOpening: usize = 0x8B8; // 
                pub const m_OnUnblockedClosing: usize = 0x8E0; // 
                pub const m_OnUnblockedOpening: usize = 0x908; // 
                pub const m_OnFullyClosed: usize = 0x930; // 
                pub const m_OnFullyOpen: usize = 0x958; // 
                pub const m_OnClose: usize = 0x980; // 
                pub const m_OnOpen: usize = 0x9A8; // 
                pub const m_OnLockedUse: usize = 0x9D0; // 
                pub const m_bLoopMoveSound: usize = 0x9F8; // 
                pub const m_bCreateNavObstacle: usize = 0xA10; // 
                pub const m_isChaining: usize = 0xA11; // 
                pub const m_bIsUsable: usize = 0xA12; // 
            }
            // Parent: None
            // Field count: 33
            //
            ...
            pub mod CFuncPlatRot {
                pub const m_end: usize = 0x840; // 
                pub const m_start: usize = 0x84C; // 
            }
            // Parent: CPointEntity
            // Field count: 5
            pub mod CEnvSpark {
            ...
            pub mod CFuncTrain {
                ...
                pub const m_activated: usize = 0x83C; // 
                pub const m_hEnemy: usize = 0x840; // 
                pub const m_flBlockDamage: usize = 0x844; // 
                pub const m_flNextBlockTime: usize = 0x848; // 
            ...
            pub mod CHostage {
                pub const m_OnHostageBeginGrab: usize = 0xAD8; // 
                pub const m_OnFirstPickedUp: usize = 0xB00; // 
                pub const m_OnDroppedNotRescued: usize = 0xB28; // 
                pub const m_OnRescued: usize = 0xB50; // 
                pub const m_entitySpottedState: usize = 0xB78; // 
                pub const m_nSpotRules: usize = 0xB90; // 
                pub const m_uiHostageSpawnExclusionGroupMask: usize = 0xB94; // 
                pub const m_nHostageSpawnRandomFactor: usize = 0xB98; // 
                pub const m_bRemove: usize = 0xB9C; // 
                pub const m_vel: usize = 0xBA0; // 
                pub const m_isRescued: usize = 0xBAC; // 
                pub const m_jumpedThisFrame: usize = 0xBAD; // 
                pub const m_nHostageState: usize = 0xBB0; // 
                pub const m_leader: usize = 0xBB4; // 
                pub const m_lastLeader: usize = 0xBB8; // 
                pub const m_reuseTimer: usize = 0xBC0; // 
                pub const m_hasBeenUsed: usize = 0xBD8; // 
                pub const m_accel: usize = 0xBDC; // 
                pub const m_isRunning: usize = 0xBE8; // 
                pub const m_isCrouching: usize = 0xBE9; // 
                pub const m_jumpTimer: usize = 0xBF0; // 
                pub const m_isWaitingForLeader: usize = 0xC08; // 
                ...
                pub const m_isAdjusted: usize = 0x2CFC; // 
                pub const m_bHandsHaveBeenCut: usize = 0x2CFD; // 
                pub const m_hHostageGrabber: usize = 0x2D00; // 
                pub const m_fLastGrabTime: usize = 0x2D04; // 
                pub const m_vecPositionWhenStartedDroppingToGround: usize = 0x2D08; // 
                pub const m_vecGrabbedPos: usize = 0x2D14; // 
                pub const m_flRescueStartTime: usize = 0x2D20; // 
                pub const m_flGrabSuccessTime: usize = 0x2D24; // 
                pub const m_flDropStartTime: usize = 0x2D28; // 
                pub const m_nApproachRewardPayouts: usize = 0x2D2C; // 
                pub const m_nPickupEventCount: usize = 0x2D30; // 
                pub const m_vecSpawnGroundPos: usize = 0x2D34; // 
                pub const m_vecHostageResetPosition: usize = 0x2D54; // 
            }
            // Parent: CPointEntity
            // Field count: 13
            ...
            pub mod CFuncMoveLinear {
                ...
                pub const m_angMoveEntitySpace: usize = 0x814; // 
                pub const m_vecMoveDirParentSpace: usize = 0x820; // 
                pub const m_soundStart: usize = 0x830; // 
                pub const m_soundStop: usize = 0x838; // 
                pub const m_currentSound: usize = 0x840; // 
                pub const m_flBlockDamage: usize = 0x848; // 
                pub const m_flStartPosition: usize = 0x84C; // 
                pub const m_OnFullyOpen: usize = 0x858; // 
                pub const m_OnFullyClosed: usize = 0x880; // 
                pub const m_bCreateMovableNavMesh: usize = 0x8A8; // 
                pub const m_bCreateNavObstacle: usize = 0x8A9; // 
            }
            // Parent: CBaseEntity
            // Field count: 3
